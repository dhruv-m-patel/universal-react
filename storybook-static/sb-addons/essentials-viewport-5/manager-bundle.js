  ...
  (() => {
                ...
                c.exports = function (n) {
                  ...
                  return function (I) {
                    var u = function () {
                      ...
                      for (C = 0; C < y; C++) {
                        if (
                          ((D[C] = { cacheItem: h, arg: arguments[C] }),
                          h.has(arguments[C]))
                        ) {
                          h = h.get(arguments[C]);
                          continue;
                      ...
                      return (
                        ...
                        A ||
                          ...
                          h.set(arguments[y], _)),
                        n > 0 &&
                          ((D[y] = { cacheItem: h, arg: arguments[y] }),
                          A ? o(r, D) : r.push(D),
    ...
    var _t = __STORYBOOK_API__,
      {
        ...
        experimental_requestResponse: Ut,
        experimental_useUniversalStore: zt,
        isMacLike: Gt,
        isShortcutTaken: Ft,
        keyToSymbol: qt,
        merge: Wt,
    ...
    var $ = ye(le()),
      ...
      Le = ({ api: e }) => {
        ...
        let S = d ? r.styles.height : r.styles.width,
          _ = d ? r.styles.width : r.styles.height;
        return i
          ? null
          : l.createElement(Be, {
              item: r,
      ...
      De = [V],
      Me = (0, $.default)(50)((e, t, a, s) =>
        e
          .filter((c) => c.id !== V.id || t.id !== c.id)
          .map((c) => ({
            ...c,
            onClick: () => {
              (a({ viewport: c.id }), s());
      ...
      Ge = Q(function () {
        ...
        let n =
            ...
            V,
          d = ee(),
          r = ze(d.current, n.styles, e.viewportRotated);
        return (
          x(() => {
            d.current = r;
          }, [n]),
            ...
            : l.createElement(
                ...
                l.createElement(
                  W,
                  {
                    placement: 'top',
                    tooltip: ({ onHide: I }) =>
                      l.createElement(q, { links: Me(p, n, t, I) }),
                    closeOnOutsideClick: !0,
                    onVisibleChange: m,
                  },
                  l.createElement(
