try {
  (() => {
    ...
    var vn = __STORYBOOK_COMPONENTS__,
      {
        A: Sn,
        ActionBar: we,
        AddonPanel: Rn,
        ...
        codeCommon: Aa,
        components: Ca,
        createCopyToClipboardFunction: Na,
        getStoryHref: wa,
        icons: xa,
        interleaveSeparators: La,
        nameSpaceClassNames: Ia,
        resetComponents: Da,
        withReset: Ma,
      } = __STORYBOOK_COMPONENTS__;
    var za = __STORYBOOK_CORE_EVENTS__,
      {
        ARGTYPES_INFO_REQUEST: Ua,
        ARGTYPES_INFO_RESPONSE: ja,
        CHANNEL_CREATED: ka,
        CHANNEL_WS_DISCONNECT: Ga,
        CONFIG_ERROR: Wa,
        CREATE_NEW_STORYFILE_REQUEST: Va,
        CREATE_NEW_STORYFILE_RESPONSE: $a,
        CURRENT_STORY_WAS_SET: Ya,
        DOCS_PREPARED: Ja,
        DOCS_RENDERED: qa,
        FILE_COMPONENT_SEARCH_REQUEST: Xa,
        FILE_COMPONENT_SEARCH_RESPONSE: Za,
        FORCE_REMOUNT: Ka,
        FORCE_RE_RENDER: Qa,
        GLOBALS_UPDATED: eo,
        NAVIGATE_URL: to,
        PLAY_FUNCTION_THREW_EXCEPTION: ro,
        PRELOAD_ENTRIES: no,
        ...
        RESET_STORY_ARGS: lo,
        RESULT_WHATS_NEW_DATA: uo,
        SAVE_STORY_REQUEST: co,
        SAVE_STORY_RESPONSE: po,
        SELECT_STORY: fo,
        SET_CONFIG: mo,
        SET_CURRENT_STORY: go,
        SET_FILTER: bo,
        SET_GLOBALS: ho,
        SET_INDEX: Eo,
        SET_STORIES: yo,
        SET_WHATS_NEW_CACHE: Oo,
        SHARED_STATE_CHANGED: To,
        SHARED_STATE_SET: _o,
        STORIES_COLLAPSE_ALL: vo,
        STORIES_EXPAND_ALL: So,
        STORY_ARGS_UPDATED: Ro,
        STORY_CHANGED: k,
        STORY_ERRORED: Ao,
        STORY_FINISHED: Co,
        STORY_INDEX_INVALIDATED: No,
        STORY_MISSING: wo,
        STORY_PREPARED: xo,
        STORY_RENDERED: Lo,
        STORY_RENDER_PHASE_CHANGED: Io,
        STORY_SPECIFIED: Do,
        STORY_THREW_EXCEPTION: Mo,
        STORY_UNCHANGED: Po,
        TELEMETRY_ERROR: Bo,
        TESTING_MODULE_CANCEL_TEST_RUN_REQUEST: Fo,
        TESTING_MODULE_CANCEL_TEST_RUN_RESPONSE: Ho,
        TESTING_MODULE_CRASH_REPORT: zo,
        TESTING_MODULE_PROGRESS_REPORT: Uo,
        TESTING_MODULE_RUN_ALL_REQUEST: jo,
        TESTING_MODULE_RUN_REQUEST: ko,
    ...
    var ni = __STORYBOOK_API__,
      {
        ...
        eventToShortcut: di,
        experimental_MockUniversalStore: mi,
        experimental_UniversalStore: gi,
        experimental_requestResponse: bi,
        experimental_useUniversalStore: hi,
        isMacLike: Ei,
        isShortcutTaken: yi,
        keyToSymbol: Oi,
        merge: Ti,
...
`,
    ...
    var _ = (function (e) {
      ...
      function t(r) {
        for (
          var n, a = arguments.length, i = new Array(a > 1 ? a - 1 : 0), s = 1;
          s < a;
          s++
        )
          i[s - 1] = arguments[s];
        return (
          (n = e.call(this, ft.apply(void 0, [pt[r]].concat(i))) || this),
          ze(n)
        );
      }
      return t;
    ...
    function F(e, t, r, n) {
      if ((n === void 0 && (n = gt), t === 0)) return n(r, r, r);
    ...
    function I(e) {
      ...
      var i = Tt.exec(t.substring(0, 50));
      if (i)
        return {
          red: parseInt('' + i[1], 10),
      ...
      var f = vt.exec(t.substring(0, 50));
      if (f) {
    ...
    var Jt = 'actions',
        ...
        if ((t && typeof t == 'object') || typeof t == 'function')
          for (let a of tt(t))
            !Qt.call(e, a) &&
              ...
              pe(e, a, {
                get: () => t[a],
                enumerable: !(n = Zt(t, a)) || n.enumerable,
              });
        return e;
      },
      rr = (e, t, r) => (
      ...
      q = {};
    er(q, { chromeDark: () => ir, chromeLight: () => sr });
    var ir = {
      ...
      ur = U((e) => {
        ...
        return o.createElement(
          ...
          o.createElement(
            ...
            s || Te.count(n) > 0
              ? o.createElement(lr, { expanded: t, styles: u.treeNodeArrow })
              : l &&
                  o.createElement(
                    'span',
    ...
    var ce = ({ data: e }) => {
      ...
      dr = ({ name: e, data: t }) =>
        typeof e == 'string'
          ...
          : o.createElement(ce, { data: t }),
      mr = ({ name: e, data: t, isNonenumerable: r = !1 }) => {
        let n = t;
        return o.createElement(
          'span',
          null,
      ...
      br = ({ depth: e, name: t, data: r, isNonenumerable: n }) =>
        e === 0
          ? o.createElement(dr, { name: t, data: r })
          : o.createElement(mr, { name: t, data: r, isNonenumerable: n }),
      hr = ({
    ...
    var Or = ({ rows: e, columns: t, rowsData: r }) => {
      ...
      Ke = ({
        ...
        return o.createElement(
          ...
          t &&
            o.createElement(Tr, null, o.createElement(_r, { sortAscending: e }))
        );
      },
      vr = ({
      ...
      Sr = ({ data: e, columns: t }) => {
        ...
        let { rowHeaders: p, colHeaders: d } = yr(e);
        t !== void 0 && (d = t);
        let f = p.map((m) => e[m]),
          E;
        if (
        ...
        return o.createElement(
          ...
          o.createElement(Or, { rows: p, columns: d, rowsData: f })
        );
      },
      Rr = de(Sr),
      Ar = 80,
      st = (e) =>
        ...
        (e.childNodes.length === 1 &&
          ...
          e.textContent.length < Ar),
      Cr = ({ tagName: e, attributes: t, styles: r }) =>
        o.createElement(
          'span',
          { style: r.base },
          '<',
      ...
      wr = ({ isCloseTag: e, data: t, expanded: r }) => {
        ...
        switch (t.nodeType) {
          ...
          case Node.DOCUMENT_FRAGMENT_NODE:
            return o.createElement('span', null, t.nodeName);
          default:
            return o.createElement('span', null, Nr[t.nodeType]);
        }
      },
      xr = function* (e) {
        if (e && e.childNodes) {
      ...
      Lr = (e) =>
        o.createElement(ot, { nodeRenderer: wr, dataIterator: xr, ...e }),
      Ir = de(Lr),
      Dr = rr(or()),
      Mr = ({ table: e = !1, data: t, ...r }) =>
        e
          ? o.createElement(Rr, { data: t, ...r })
          : (0, Dr.default)(t)
            ? o.createElement(Ir, { data: t, ...r })
            : o.createElement(Er, { data: t, ...r }),
      Pr = B.div({
        display: 'flex',
        padding: 0,
      ...
      Fr = B.div({ flex: 1, padding: '0 0 0 5px' }),
    ...
    var Hr = B(lt)({ margin: 0, padding: '10px 5px 20px' }),
      zr = He(({ theme: e, ...t }) =>
        o.createElement(Mr, {
            ...
            o.createElement(
              ...
              e.map((i) =>
                o.createElement(
                  Pr,
                  { key: i.id },
                  i.count > 1 && o.createElement(Br, null, i.count),
                  o.createElement(
                    Fr,
                    null,
                    o.createElement(zr, {
      ...
      kr = class extends _e {
        ...
        render() {
          ...
          return t ? o.createElement(Ur, { ...r }) : null;
        }
      };
    function Gr() {
    ...
    Q.register(z, (e) => {
      Q.add(qt, {
        title: Gr,
        type: De.PANEL,
        render: ({ active: t }) => o.createElement(kr, { api: e, active: !!t }),
        paramKey: Jt,
      });
    });
  })();
