...
function S(e, t) {
  if (!e) {
    var o = typeof t == 'function' ? t() : t,
      l = o ? ''.concat(T, ': ').concat(o) : T;
    throw new Error(l);
  }
}
...
function Z() {
  (S(h.canvas, 'Canvas should exist in the state.'),
    S(h.context, 'Context should exist in the state.'),
    A(h.canvas, h.context, { width: 0, height: 0 }));
...
var w = {
  ...
  p = 6;
function B(e, { x: t, y: o, w: l, h: i, r: n }) {
  ((t = t - l / 2),
    (o = o - i / 2),
    l < 2 * n && (n = l / 2),
    i < 2 * n && (n = i / 2),
...
function et(e, t, o) {
  return (
    e === 'top'
      ? (t.y = o.y - o.h - p)
      : e === 'right'
        ? (t.x = o.x + o.w / 2 + p + t.w / 2)
        : e === 'bottom'
          ? (t.y = o.y + o.h + p)
          : e === 'left' && (t.x = o.x - o.w / 2 - p - t.w / 2),
    { x: t.x, y: t.y }
  );
}
function X(e, t, { x: o, y: l, w: i, h: n }, r) {
  return (
    B(e, { x: o, y: l, w: i, h: n, r: 3 }),
    (e.fillStyle = `${w[t]}dd`),
    e.fill(),
    (e.strokeStyle = w[t]),
    e.stroke(),
...
function ot(e, t, { type: o, position: l = 'center', text: i }, n, r = !1) {
  let { x: f, y: a } = Q(l, t),
    { offsetX: s, offsetY: u } = x(o, l, t, p + 1, r);
  ((f += s), (a += u));
  let { w: g, h: m } = k(e, i);
  if (n && tt({ x: f, y: a, w: g, h: m }, n)) {
    let E = et(l, { x: f, y: a, w: g }, n);
    ((f = E.x), (a = E.y));
  }
...
function nt(e, t, o, l) {
  ...
  (i.top && v(e, t, i.top, l),
    i.right && v(e, t, i.right, l),
    i.bottom && v(e, t, i.bottom, l),
    i.left && v(e, t, i.left, l),
    i.center && v(e, t, i.center, l));
}
var L = {
    margin: '#f6b26ba8',
    border: '#ffe599a8',
...
function rt(e) {
  ...
  let y = { top: c(a), bottom: c(s), left: c(u), right: c(g) },
    z = { top: c(m), bottom: c(E), left: c(F), right: c(I) },
    j = { top: c($), bottom: c(D), left: c(N), right: c(q) },
    _ = {
      top: o - y.top,
      bottom: n + y.bottom,
      left: l - y.left,
...
var ct = (e, t) => {
  ...
  pt = [ct],
  wt = { [K]: !1 };
export { pt as decorators, wt as initialGlobals };
