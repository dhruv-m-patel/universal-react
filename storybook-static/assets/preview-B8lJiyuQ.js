...
var p = 'backgrounds',
  ...
  D = () => {
    ...
    return !!(
      (r =
        O == null
          ? void 0
          : O.matchMedia('(prefers-reduced-motion: reduce)')) != null &&
      r.matches
    );
  },
  A = (r) => {
  ...
  Y = (r, e, t) => {
    ...
    if (o) o.innerHTML !== e && (o.innerHTML = e);
      ...
      n
        ? (a = n.parentElement) == null || a.insertBefore(d, n)
  ...
  Z = (r, e) => {
    ...
    let { globals: t, parameters: o } = e,
      ...
      d = o[p],
      i = h(
        () => (d.disable ? 'transparent' : Q(a, d.values, d.default)),
        [d, a]
      ),
  ...
  C,
  ae =
    (C = globalThis.FEATURES) != null && C.backgroundsStoryGlobals
      ? [J]
      : [V, Z],
  I,
  oe = {
  ...
  z,
  de =
    (z = globalThis.FEATURES) != null && z.backgroundsStoryGlobals
      ? ee
      : { [p]: null };
