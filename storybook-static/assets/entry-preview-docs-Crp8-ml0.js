import {
  ...
  d as Wr,
  b as xn,
} from './chunk-XP5HYGXS-BpfKkqn7.js';
import {
  c as Ci,
  n as yi,
  y as Fi,
  ...
  a as St,
  Y as Yr,
} from './index-Bhelpi4i.js';
import { r as tt, R as Ft } from './index-CfFaKb_3.js';
import './_commonjsHelpers-Cpj98o6Y.js';
const { logger: kt } = __STORYBOOK_MODULE_CLIENT_LOGGER__,
  {
    defaultDecorateStory: Si,
    addons: bi,
    useEffect: Bi,
    ...
    '../../node_modules/object-assign/index.js'(e, t) {
      ...
      function u() {
        try {
          ...
          var g = Object.getOwnPropertyNames(p).map(function (A) {
            return p[A];
          });
          ...
          return (
            ...
            Object.keys(Object.assign({}, F)).join('') ===
      ...
      t.exports = u()
        ? Object.assign
        : function (l, p) {
            for (var d, g = o(l), F, A = 1; A < arguments.length; A++) {
              d = Object(arguments[A]);
              for (var E in d) n.call(d, E) && (g[E] = d[E]);
              if (r) {
                F = r(d);
                for (var D = 0; D < F.length; D++)
                  s.call(d, F[D]) && (g[F[D]] = d[F[D]]);
              }
            }
            return g;
          };
    ...
    '../../node_modules/prop-types/factoryWithTypeCheckers.js'(e, t) {
      ...
      t.exports = function (d, g) {
            ...
            if (!Array.isArray(re)) {
              ...
              return new k(
                'Invalid ' +
                  ...
                  K +
                  '` of type ' +
                  ('`' + se + '` supplied to `' + M + '`, expected an array.')
              );
            }
            for (var le = 0; le < re.length; le++) {
              var $ = b(re, le, M, H, K + '[' + le + ']', s);
        ...
        function I(b) {
          ...
          function j(X, Q, M, H, K) {
            for (var re = X[Q], se = 0; se < b.length; se++)
              if (T(re, b[se])) return null;
            var le = JSON.stringify(b, function ($, N) {
              var ue = Ee(N);
            ...
            return new k(
              'Invalid ' +
                ...
                String(re) +
                '` ' +
                ('supplied to `' + M + '`, expected one of ' + le + '.')
            );
          }
          return x(j);
        }
            ...
            if (se !== 'object')
              return new k(
                'Invalid ' +
                  ...
                  K +
                  '` of type ' +
                  ('`' + se + '` supplied to `' + M + '`, expected an object.')
              );
            for (var le in re)
              if (o(re, le)) {
                var $ = b(re, le, M, H, K + '.' + le, s);
        ...
        function U(b) {
          ...
          function Q(M, H, K, re, se) {
            for (var le = [], $ = 0; $ < b.length; $++) {
              var N = b[$],
                ue = N(M, H, K, re, se, s);
              if (ue == null) return null;
              ue.data &&
                o(ue.data, 'expectedType') &&
                le.push(ue.data.expectedType);
            }
            var W =
              le.length > 0
                ? ', expected one of type [' + le.join(', ') + ']'
                : '';
            return new k(
              'Invalid ' +
                re +
        ...
        function ee(b) {
          function j(X, Q, M, H, K) {
            ...
            for (var le in b) {
              var $ = b[le];
              if (typeof $ != 'function') return G(M, H, K, le, Ee($));
              var N = $(re, le, M, H, K + '.' + le, s);
              if (N) return N;
            }
            return null;
          }
              ...
              if (!N)
                return new k(
                  'Invalid ' +
                    ...
                    `
Valid keys: ` +
                    JSON.stringify(Object.keys(b), null, '  ')
                );
              var ue = N(re, $, M, H, K + '.' + $, s);
              if (ue) return ue;
            }
        ...
        function pe(b) {
          switch (typeof b) {
            ...
            case 'boolean':
              return !b;
            case 'object':
              if (Array.isArray(b)) return b.every(pe);
              ...
              if (j) {
                var X = j.call(b),
                  Q;
                if (j !== b.entries) {
                  for (; !(Q = X.next()).done; ) if (!pe(Q.value)) return !1;
                } else
                  for (; !(Q = X.next()).done; ) {
                    var M = Q.value;
        ...
        return (
          (C.checkPropTypes = u),
          (C.resetWarningCache = u.resetWarningCache),
          (C.PropTypes = C),
          C
        );
      };
  ...
  Ii = he({
    '../../node_modules/prop-types/index.js'(e, t) {
      ((r = Sn()), (n = !0), (t.exports = Pi()(r.isElement, n)));
      var r, n;
    },
  }),
  Oi = he({
      ...
      (function t(r) {
        ...
        function d(v) {
          ...
          for (_ in v)
            v.hasOwnProperty(_) &&
              ((B = v[_]),
              typeof B == 'object' && B !== null ? (y[_] = d(B)) : (y[_] = B));
          return y;
        }
        function g(v, y) {
          var _, B, I, q;
          for (B = v.length, I = 0; B; )
            ((_ = B >>> 1),
              (q = I + _),
              y(v[q]) ? (B = _) : ((I = q + 1), (B -= _ + 1)));
          return I;
        }
        ((n = {
          ...
          (l = {}),
          (p = {}),
          (s = { Break: u, Skip: l, Remove: p }));
        function F(v, y) {
          ((this.parent = v), (this.key = y));
        }
        ...
        function A(v, y, _, B) {
          ((this.node = v), (this.path = y), (this.wrap = _), (this.ref = B));
        }
        function E() {}
        ((E.prototype.path = function () {
          ...
          function U(z, G) {
            if (Array.isArray(G))
              for (_ = 0, B = G.length; _ < B; ++_) z.push(G[_]);
            else z.push(G);
          }
          if (!this.__current.path) return null;
          for (I = [], v = 2, y = this.__leavelist.length; v < y; ++v)
            ((q = this.__leavelist[v]), U(I, q.path));
          ...
          (E.prototype.parents = function () {
            var v, y, _;
            for (_ = [], v = 1, y = this.__leavelist.length; v < y; ++v)
              _.push(this.__leavelist[v].node);
            return _;
          }),
          (E.prototype.current = function () {
            return this.__current.node;
          }),
          (E.prototype.__execute = function (v, y) {
            var _, B;
            return (
              (B = void 0),
              (_ = this.__current),
          ...
          (E.prototype.__initialize = function (v, y) {
            ((this.visitor = y),
              (this.root = v),
              (this.__worklist = []),
              (this.__leavelist = []),
              ...
              y.fallback === 'iteration'
                ...
                : typeof y.fallback == 'function' &&
                  (this.__fallback = y.fallback),
              (this.__keys = o),
              y.keys &&
        ...
        function D(v) {
          return v == null
            ? !1
            : typeof v == 'object' && typeof v.type == 'string';
        }
        function C(v, y) {
          return (
            (v === n.ObjectExpression || v === n.ObjectPattern) &&
            y === 'properties'
          );
        }
        function T(v, y) {
          for (var _ = v.length - 1; _ >= 0; --_)
            if (v[_].node === y) return !0;
          return !1;
        }
        ((E.prototype.traverse = function (v, y) {
          var _, B, I, q, U, z, G, ee, de, pe, me, te;
          for (
            this.__initialize(v, y),
              te = {},
              _ = this.__worklist,
              B = this.__leavelist,
              _.push(new A(v, null, null, null)),
            ...
            if (I.node) {
              if (
                ((z = this.__execute(y.enter, I)),
                this.__state === u || z === u)
              )
                return;
              if ((_.push(te), B.push(I), this.__state === l || z === l))
                continue;
              if (
                ((q = I.node),
                (U = q.type || I.wrap),
                ...
                else throw new Error('Unknown node type ' + U + '.');
              for (ee = pe.length; (ee -= 1) >= 0; )
                if (((G = pe[ee]), (me = q[G]), !!me)) {
                  if (Array.isArray(me)) {
                    for (de = me.length; (de -= 1) >= 0; )
                      if (me[de] && !T(B, me[de])) {
                        if (C(U, pe[ee]))
                          I = new A(me[de], [G, de], 'Property', null);
                        else if (D(me[de]))
                          I = new A(me[de], [G, de], null, null);
                        else continue;
                        _.push(I);
                      }
                  } else if (D(me)) {
                    if (T(B, me)) continue;
                    _.push(new A(me, G, null, null));
                  }
                }
            }
          }
        }),
          (E.prototype.replace = function (v, y) {
            var _, B, I, q, U, z, G, ee, de, pe, me, te, Ee;
            function Re(Be) {
              var b, j, X, Q;
              if (Be.ref.remove()) {
                for (j = Be.ref.key, Q = Be.ref.parent, b = _.length; b--; )
                  if (((X = _[b]), X.ref && X.ref.parent === Q)) {
                    if (X.ref.key < j) break;
                    --X.ref.key;
                  }
              }
            }
            for (
              this.__initialize(v, y),
                ...
                B = this.__leavelist,
                te = { root: v },
                z = new A(v, null, null, new F(te, 'root')),
                _.push(z),
                B.push(z);
              _.length;
            ) {
              ...
              if (
                ((U = this.__execute(y.enter, z)),
                U !== void 0 &&
                  U !== u &&
                  U !== l &&
                  U !== p &&
                  (z.ref.replace(U), (z.node = U)),
                (this.__state === p || U === p) && (Re(z), (z.node = null)),
                this.__state === u || U === u)
              )
                return te.root;
              if (
                ((I = z.node),
                !!I &&
                  (_.push(me), B.push(z), !(this.__state === l || U === l)))
              ) {
                if (((q = I.type || z.wrap), (de = this.__keys[q]), !de))
                  if (this.__fallback) de = this.__fallback(I);
                      ...
                      for (ee = pe.length; (ee -= 1) >= 0; )
                        if (pe[ee]) {
                          if (C(q, de[G]))
                            ...
                            z = new A(pe[ee], [Ee, ee], null, new F(pe, ee));
                          else continue;
                          _.push(z);
                        }
                    } else D(pe) && _.push(new A(pe, Ee, null, new F(I, Ee)));
              }
            }
            return te.root;
          }));
        function k(v, y) {
          var _ = new E();
          return _.traverse(v, y);
        }
        function x(v, y) {
          var _ = new E();
          return _.replace(v, y);
        }
        function R(v, y) {
          var _;
          return (
            ...
            _ !== y.length && (v.extendedRange[1] = y[_].range[0]),
            (_ -= 1),
            _ >= 0 && (v.extendedRange[0] = y[_].range[1]),
            v
          );
        }
        function S(v, y, _) {
          ...
          if (!_.length) {
            if (y.length) {
              for (U = 0, q = y.length; U < q; U += 1)
                ((I = d(y[U])), (I.extendedRange = [0, v.range[0]]), B.push(I));
              v.leadingComments = B;
            }
            return v;
          }
          for (U = 0, q = y.length; U < q; U += 1) B.push(R(d(y[U]), _));
          return (
            (z = 0),
            k(v, {
              enter: function (G) {
                for (
                  var ee;
                  z < B.length &&
                  ((ee = B[z]), !(ee.extendedRange[1] > G.range[0]));
                )
                  ee.extendedRange[1] === G.range[0]
                    ? (G.leadingComments || (G.leadingComments = []),
                      G.leadingComments.push(ee),
                      B.splice(z, 1))
                    : (z += 1);
                if (z === B.length) return s.Break;
                if (B[z].extendedRange[0] > G.range[1]) return s.Skip;
              },
            }),
            (z = 0),
            k(v, {
              leave: function (G) {
                for (
                  var ee;
                  z < B.length &&
                  ((ee = B[z]), !(G.range[1] < ee.extendedRange[0]));
                )
                  G.range[1] === ee.extendedRange[0]
                    ? (G.trailingComments || (G.trailingComments = []),
    ...
    '../../node_modules/esutils/lib/ast.js'(e, t) {
      (function () {
        ...
        function l(p) {
          ...
          d = p.consequent;
          do {
            if (d.type === 'IfStatement' && d.alternate == null) return !0;
            d = u(d);
          } while (d);
          return !1;
        }
    ...
    '../../node_modules/esutils/lib/code.js'(e, t) {
      (function () {
        ...
        function E(x) {
          ...
          var R = String.fromCharCode(Math.floor((x - 65536) / 1024) + 55296),
            S = String.fromCharCode(((x - 65536) % 1024) + 56320);
          return R + S;
        }
        ...
        for (u = new Array(128), l = 0; l < 128; ++l)
          u[l] =
            ...
            l === 95;
        function D(x) {
          return x < 128 ? o[x] : n.NonAsciiIdentifierStart.test(E(x));
        }
        function C(x) {
          return x < 128 ? u[x] : n.NonAsciiIdentifierPart.test(E(x));
        }
        function T(x) {
          return x < 128 ? o[x] : r.NonAsciiIdentifierStart.test(E(x));
        }
        function k(x) {
          return x < 128 ? u[x] : r.NonAsciiIdentifierPart.test(E(x));
        }
        t.exports = {
          isDecimalDigit: p,
          isHexDigit: d,
  ...
  ji = he({
    '../../node_modules/esutils/lib/keyword.js'(e, t) {
      (function () {
        ...
        function l(D, C) {
          return D === 'null' || D === 'true' || D === 'false' || o(D, C);
        }
        function p(D) {
        ...
        function d(D) {
          ...
          if (
            D.length === 0 ||
            ((k = D.charCodeAt(0)), !r.isIdentifierStartES5(k))
          )
            return !1;
          for (C = 1, T = D.length; C < T; ++C)
            if (((k = D.charCodeAt(C)), !r.isIdentifierPartES5(k))) return !1;
          return !0;
        }
        function g(D, C) {
        ...
        function F(D) {
          ...
          for (R = r.isIdentifierStartES6, C = 0, T = D.length; C < T; ++C) {
            if (((k = D.charCodeAt(C)), 55296 <= k && k <= 56319)) {
              if (
                (++C,
                C >= T || ((x = D.charCodeAt(C)), !(56320 <= x && x <= 57343)))
              )
                return !1;
              k = g(k, x);
            }
            if (!R(k)) return !1;
            R = r.isIdentifierPartES6;
          }
          return !0;
        }
        function A(D, C) {
  ...
  Mi = he({
    '../../node_modules/esutils/lib/utils.js'(e) {
      (function () {
        ((e.ast = Ni()), (e.code = wn()), (e.keyword = ji()));
      })();
    },
  }),
  Vi = he({
    ...
    '../../node_modules/escodegen/node_modules/source-map/lib/base64-vlq.js'(
      ...
      ((e.encode = function (p) {
        var d = '',
          g,
          F = u(p);
        do ((g = F & s), (F >>>= r), F > 0 && (g |= o), (d += t.encode(g)));
        while (F > 0);
        return d;
      }),
        (e.decode = function (p, d, g) {
          var F = p.length,
            A = 0,
            E = 0,
            D,
          ...
          do {
            ...
            if (((C = t.decode(p.charCodeAt(d++))), C === -1))
              throw new Error('Invalid base64 digit: ' + p.charAt(d - 1));
            ((D = !!(C & o)), (C &= s), (A = A + (C << E)), (E += r));
          } while (D);
          ((g.value = l(A)), (g.rest = d));
        }));
    },
  }),
  bt = he({
    '../../node_modules/escodegen/node_modules/source-map/lib/util.js'(e) {
      ...
      function s(S) {
        var v = S.match(r);
        return v
          ? { scheme: v[1], auth: v[2], host: v[3], port: v[4], path: v[5] }
          : null;
      }
      e.urlParse = s;
      function o(S) {
      ...
      function l(S, v) {
        ...
        var y = s(v),
          _ = s(S);
        if ((_ && (S = _.path || '/'), y && !y.scheme))
          return (_ && (y.scheme = _.scheme), o(y));
        if (y || v.match(n)) return v;
        if (_ && !_.host && !_.path) return ((_.host = v), o(_));
        var B = v.charAt(0) === '/' ? v : u(S.replace(/\/+$/, '') + '/' + v);
        return _ ? ((_.path = B), o(_)) : B;
      }
      ((e.join = l),
      ...
      function p(S, v) {
        (S === '' && (S = '.'), (S = S.replace(/\/$/, '')));
        for (var y = 0; v.indexOf(S + '/') !== 0; ) {
          var _ = S.lastIndexOf('/');
          if (_ < 0 || ((S = S.slice(0, _)), S.match(/^([^\/]+:\/)?\/*$/)))
            return v;
          ++y;
        }
        return Array(y + 1).join('../') + v.substr(S.length + 1);
      }
      e.relative = p;
      var d = (function () {
      ...
      e.toSetString = d ? g : F;
      function A(S) {
        return E(S) ? S.slice(1) : S;
      }
      e.fromSetString = d ? g : A;
      function E(S) {
        if (!S) return !1;
        var v = S.length;
        if (
          ...
          S.charCodeAt(v - 1) !== 95 ||
          S.charCodeAt(v - 2) !== 95 ||
          S.charCodeAt(v - 3) !== 111 ||
          S.charCodeAt(v - 4) !== 116 ||
          S.charCodeAt(v - 5) !== 111 ||
          S.charCodeAt(v - 6) !== 114 ||
          S.charCodeAt(v - 7) !== 112 ||
          S.charCodeAt(v - 8) !== 95 ||
          S.charCodeAt(v - 9) !== 95
        )
          return !1;
        for (var y = v - 10; y >= 0; y--) if (S.charCodeAt(y) !== 36) return !1;
        return !0;
      }
      function D(S, v, y) {
        var _ = T(S.source, v.source);
        return _ !== 0 ||
          ((_ = S.originalLine - v.originalLine), _ !== 0) ||
          ((_ = S.originalColumn - v.originalColumn), _ !== 0 || y) ||
          ((_ = S.generatedColumn - v.generatedColumn), _ !== 0) ||
          ((_ = S.generatedLine - v.generatedLine), _ !== 0)
          ? _
          : T(S.name, v.name);
      }
      e.compareByOriginalPositions = D;
      function C(S, v, y) {
        var _ = S.generatedLine - v.generatedLine;
        return _ !== 0 ||
          ((_ = S.generatedColumn - v.generatedColumn), _ !== 0 || y) ||
          ((_ = T(S.source, v.source)), _ !== 0) ||
          ((_ = S.originalLine - v.originalLine), _ !== 0) ||
          ((_ = S.originalColumn - v.originalColumn), _ !== 0)
          ? _
          : T(S.name, v.name);
      }
      e.compareByGeneratedPositionsDeflated = C;
      function T(S, v) {
        return S === v ? 0 : S === null ? 1 : v === null ? -1 : S > v ? 1 : -1;
      }
      function k(S, v) {
        var y = S.generatedLine - v.generatedLine;
        return y !== 0 ||
          ((y = S.generatedColumn - v.generatedColumn), y !== 0) ||
          ((y = T(S.source, v.source)), y !== 0) ||
          ((y = S.originalLine - v.originalLine), y !== 0) ||
          ((y = S.originalColumn - v.originalColumn), y !== 0)
          ? y
          : T(S.name, v.name);
      }
      ...
      function R(S, v, y) {
        if (
          ...
          if (_.path) {
            var B = _.path.lastIndexOf('/');
            B >= 0 && (_.path = _.path.substring(0, B + 1));
          }
          v = l(o(_), v);
        }
        return u(v);
  ...
  kn = he({
    '../../node_modules/escodegen/node_modules/source-map/lib/array-set.js'(e) {
      ...
      ((s.fromArray = function (o, u) {
        for (var l = new s(), p = 0, d = o.length; p < d; p++) l.add(o[p], u);
        return l;
      }),
        ...
        (s.prototype.add = function (o, u) {
          var l = n ? o : t.toSetString(o),
            p = n ? this.has(o) : r.call(this._set, l),
            d = this._array.length;
          ((!p || u) && this._array.push(o),
            p || (n ? this._set.set(o, d) : (this._set[l] = d)));
        }),
        ...
        (s.prototype.indexOf = function (o) {
          if (n) {
            ...
            if (r.call(this._set, l)) return this._set[l];
          }
    ...
    '../../node_modules/escodegen/node_modules/source-map/lib/mapping-list.js'(
      ...
      function r(s, o) {
        ...
        return (
          l > u ||
          (l == u && d >= p) ||
          t.compareByGeneratedPositionsInflated(s, o) <= 0
        );
      }
      function n() {
        ((this._array = []),
    ...
    '../../node_modules/escodegen/node_modules/source-map/lib/source-map-generator.js'(
      ...
      ((o.prototype._version = 3),
        (o.fromSourceMap = function (u) {
          var l = u.sourceRoot,
            p = new o({ file: u.file, sourceRoot: l });
          return (
            u.eachMapping(function (d) {
              var g = {
                generated: { line: d.generatedLine, column: d.generatedColumn },
              };
              (d.source != null &&
                ((g.source = d.source),
                l != null && (g.source = r.relative(l, g.source)),
                (g.original = {
                  line: d.originalLine,
                  column: d.originalColumn,
                }),
                d.name != null && (g.name = d.name)),
                p.addMapping(g));
            }),
            u.sources.forEach(function (d) {
              var g = d;
              (l !== null && (g = r.relative(l, d)),
                p._sources.has(g) || p._sources.add(g));
              var F = u.sourceContentFor(d);
        ...
        (o.prototype.addMapping = function (u) {
          var l = r.getArg(u, 'generated'),
            p = r.getArg(u, 'original', null),
            d = r.getArg(u, 'source', null),
            g = r.getArg(u, 'name', null);
          (this._skipValidation || this._validateMapping(l, p, d, g),
            d != null &&
        ...
        (o.prototype.applySourceMap = function (u, l, p) {
          ...
          g != null && (d = r.relative(g, d));
          var F = new n(),
            A = new n();
          (this._mappings.unsortedForEach(function (E) {
            if (E.source === d && E.originalLine != null) {
              var D = u.originalPositionFor({
                line: E.originalLine,
                column: E.originalColumn,
              });
              D.source != null &&
                ((E.source = D.source),
                p != null && (E.source = r.join(p, E.source)),
                g != null && (E.source = r.relative(g, E.source)),
                (E.originalLine = D.line),
                (E.originalColumn = D.column),
                D.name != null && (E.name = D.name));
            }
            var C = E.source;
            C != null && !F.has(C) && F.add(C);
            var T = E.name;
            T != null && !A.has(T) && A.add(T);
          }, this),
            (this._sources = F),
            (this._names = A),
            u.sources.forEach(function (E) {
              var D = u.sourceContentFor(E);
              D != null &&
                (p != null && (E = r.join(p, E)),
                g != null && (E = r.relative(g, E)),
                this.setSourceContent(E, D));
            }, this));
        }),
        (o.prototype._validateMapping = function (u, l, p, d) {
        ...
        (o.prototype._serializeMappings = function () {
          for (
            ...
            if (((D = k[x]), (E = ''), D.generatedLine !== l))
              for (u = 0; D.generatedLine !== l; ) ((E += ';'), l++);
            else if (x > 0) {
              if (!r.compareByGeneratedPositionsInflated(D, k[x - 1])) continue;
              E += ',';
            }
            ((E += t.encode(D.generatedColumn - u)),
              (u = D.generatedColumn),
              D.source != null &&
                ((T = this._sources.indexOf(D.source)),
                (E += t.encode(T - F)),
                (F = T),
                (E += t.encode(D.originalLine - 1 - d)),
                (d = D.originalLine - 1),
                (E += t.encode(D.originalColumn - p)),
                (p = D.originalColumn),
                D.name != null &&
                  ((C = this._names.indexOf(D.name)),
                  (E += t.encode(C - g)),
                  (g = C))),
              (A += E));
          }
        ...
        (o.prototype._generateSourcesContent = function (u, l) {
          return u.map(function (p) {
            if (!this._sourcesContents) return null;
            l != null && (p = r.relative(l, p));
            var d = r.toSetString(p);
        ...
        (o.prototype.toJSON = function () {
          ...
          return (
            ...
            this._sourcesContents &&
              (u.sourcesContent = this._generateSourcesContent(
                u.sources,
                u.sourceRoot
              )),
            u
      ...
      function n(s, o, u, l) {
        if (u < l) {
          var p = r(u, l),
            d = u - 1;
          t(s, p, l);
          for (var g = s[l], F = u; F < l; F++)
            o(s[F], g) <= 0 && ((d += 1), t(s, d, F));
          t(s, d + 1, F);
          var A = d + 1;
          (n(s, o, u, A - 1), n(s, o, A + 1, l));
        }
      }
    ...
    '../../node_modules/escodegen/node_modules/source-map/lib/source-map-consumer.js'(
      ...
      function u(g, F) {
        ...
        return (
          ...
          A.sections != null ? new d(A, F) : new l(A, F)
        );
      }
      ((u.fromSourceMap = function (g, F) {
        return l.fromSourceMap(g, F);
      }),
        ...
        (u.prototype.eachMapping = function (g, F, A) {
          ...
          C.map(function (k) {
            var x = k.source === null ? null : this._sources.at(k.source);
            return (
              (x = t.computeSourceURL(T, x, this._sourceMapURL)),
              {
                source: x,
        ...
        (u.prototype.allGeneratedPositionsFor = function (g) {
          ...
          if (D >= 0) {
            var C = this._originalMappings[D];
            if (g.column === void 0)
              for (var T = C.originalLine; C && C.originalLine === T; )
                (E.push({
                  ...
                  (C = this._originalMappings[++D]));
            else
              for (
                var k = C.originalColumn;
                C && C.originalLine === F && C.originalColumn == k;
              )
                (E.push({
                  line: t.getArg(C, 'generatedLine', null),
                  column: t.getArg(C, 'generatedColumn', null),
      ...
      function l(g, F) {
        var A = g;
        typeof g == 'string' && (A = t.parseSourceMapInput(g));
        var E = t.getArg(A, 'version'),
          D = t.getArg(A, 'sources'),
          C = t.getArg(A, 'names', []),
          T = t.getArg(A, 'sourceRoot', null),
          k = t.getArg(A, 'sourcesContent', null),
          x = t.getArg(A, 'mappings'),
          R = t.getArg(A, 'file', null);
        if (E != this._version) throw new Error('Unsupported version: ' + E);
        (T && (T = t.normalize(T)),
          (D = D.map(String)
            .map(t.normalize)
            .map(function (S) {
              return T && t.isAbsolute(T) && t.isAbsolute(S)
                ? t.relative(T, S)
                : S;
            })),
          (this._names = n.fromArray(C.map(String), !0)),
          (this._sources = n.fromArray(D, !0)),
          (this._absoluteSources = this._sources.toArray().map(function (S) {
            return t.computeSourceURL(T, S, F);
          })),
          (this.sourceRoot = T),
      ...
      ((l.prototype = Object.create(u.prototype)),
        ...
        (l.prototype._findSourceIndex = function (g) {
          var F = g;
          if (
        ...
        (l.fromSourceMap = function (g, F) {
          var A = Object.create(l.prototype),
            E = (A._names = n.fromArray(g._names.toArray(), !0)),
            D = (A._sources = n.fromArray(g._sources.toArray(), !0));
          ((A.sourceRoot = g._sourceRoot),
            (A.sourcesContent = g._generateSourcesContent(
              A._sources.toArray(),
              A.sourceRoot
            )),
            (A.file = g._file),
          ...
          for (
            var C = g._mappings.toArray().slice(),
              T = (A.__generatedMappings = []),
              k = (A.__originalMappings = []),
              x = 0,
              R = C.length;
            x < R;
            x++
            ...
            var S = C[x],
              v = new p();
            ((v.generatedLine = S.generatedLine),
              (v.generatedColumn = S.generatedColumn),
              S.source &&
                ((v.source = D.indexOf(S.source)),
                (v.originalLine = S.originalLine),
                (v.originalColumn = S.originalColumn),
                S.name && (v.name = E.indexOf(S.name)),
                k.push(v)),
              T.push(v));
          }
      ...
      ((l.prototype._parseMappings = function (g, F) {
        for (
          var A = 1,
            E = 0,
            D = 0,
          ...
          if (g.charAt(R) === ';') (A++, R++, (E = 0));
          else if (g.charAt(R) === ',') R++;
          else {
            for (
              B = new p(), B.generatedLine = A, U = R;
              U < x && !this._charIsMappingSeparator(g, U);
              U++
            );
            if (((I = g.slice(R, U)), (q = S[I]), q)) R += I.length;
            else {
              for (q = []; R < U; )
                (s.decode(g, R, v), (z = v.value), (R = v.rest), q.push(z));
              if (q.length === 2)
            ...
            ((B.generatedColumn = E + q[0]),
              ...
              q.length > 1 &&
                ((B.source = T + q[1]),
                (T += q[1]),
                (B.originalLine = D + q[2]),
                (D = B.originalLine),
                (B.originalLine += 1),
                (B.originalColumn = C + q[3]),
                (C = B.originalColumn),
                q.length > 4 && ((B.name = k + q[4]), (k += q[4]))),
              _.push(B),
              typeof B.originalLine == 'number' && y.push(B));
          }
        (o(_, t.compareByGeneratedPositionsDeflated),
          (this.__generatedMappings = _),
          o(y, t.compareByOriginalPositions),
          (this.__originalMappings = y));
      }),
        (l.prototype._findMapping = function (g, F, A, E, D, C) {
          if (g[A] <= 0)
            throw new TypeError(
              'Line must be greater than or equal to 1, got ' + g[A]
            );
          if (g[E] < 0)
            throw new TypeError(
              'Column must be greater than or equal to 0, got ' + g[E]
            );
          return r.search(g, F, D, C);
        }),
        ...
        (l.prototype.originalPositionFor = function (g) {
          ...
          if (A >= 0) {
            var E = this._generatedMappings[A];
            if (E.generatedLine === F.generatedLine) {
              var D = t.getArg(E, 'source', null);
              D !== null &&
                ((D = this._sources.at(D)),
                (D = t.computeSourceURL(
                  this.sourceRoot,
                  D,
                  this._sourceMapURL
                )));
              var C = t.getArg(E, 'name', null);
              return (
        ...
        (l.prototype.sourceContentFor = function (g, F) {
          if (!this.sourcesContent) return null;
          var A = this._findSourceIndex(g);
          if (A >= 0) return this.sourcesContent[A];
          var E = g;
          this.sourceRoot != null && (E = t.relative(this.sourceRoot, E));
          var D;
          if (this.sourceRoot != null && (D = t.urlParse(this.sourceRoot))) {
            var C = E.replace(/^file:\/\//, '');
            if (D.scheme == 'file' && this._sources.has(C))
              return this.sourcesContent[this._sources.indexOf(C)];
            if ((!D.path || D.path == '/') && this._sources.has('/' + E))
        ...
        (l.prototype.generatedPositionFor = function (g) {
          ...
          if (E >= 0) {
            var D = this._originalMappings[E];
      ...
      function d(g, F) {
        ...
        this._sections = D.map(function (T) {
          if (T.url)
            throw new Error(
          ...
          var k = t.getArg(T, 'offset'),
            x = t.getArg(k, 'line'),
            R = t.getArg(k, 'column');
          if (x < C.line || (x === C.line && R < C.column))
            throw new Error(
          ...
          return (
            (C = k),
            {
              generatedOffset: { generatedLine: x + 1, generatedColumn: R + 1 },
              consumer: new u(t.getArg(T, 'map'), F),
            }
          );
        });
      }
      ((d.prototype = Object.create(u.prototype)),
        ...
        Object.defineProperty(d.prototype, 'sources', {
          get: function () {
            for (var g = [], F = 0; F < this._sections.length; F++)
              for (
                var A = 0;
                A < this._sections[F].consumer.sources.length;
                A++
              )
        ...
        (d.prototype.originalPositionFor = function (g) {
          var F = {
            ...
            A = r.search(F, this._sections, function (D, C) {
              var T = D.generatedLine - C.generatedOffset.generatedLine;
              return T || D.generatedColumn - C.generatedOffset.generatedColumn;
            }),
            E = this._sections[A];
          return E
            ? E.consumer.originalPositionFor({
                line: F.generatedLine - (E.generatedOffset.generatedLine - 1),
                column:
                  F.generatedColumn -
                  (E.generatedOffset.generatedLine === F.generatedLine
        ...
        (d.prototype.sourceContentFor = function (g, F) {
          for (var A = 0; A < this._sections.length; A++) {
            var E = this._sections[A],
              D = E.consumer.sourceContentFor(g, !0);
            if (D) return D;
          }
          if (F) return null;
        ...
        (d.prototype.generatedPositionFor = function (g) {
          for (var F = 0; F < this._sections.length; F++) {
            ...
            if (A.consumer._findSourceIndex(t.getArg(g, 'source')) !== -1) {
              var E = A.consumer.generatedPositionFor(g);
              if (E) {
                var D = {
                  line: E.line + (A.generatedOffset.generatedLine - 1),
                  column:
                    E.column +
                    (A.generatedOffset.generatedLine === E.line
        ...
        (d.prototype._parseMappings = function (g, F) {
          ((this.__generatedMappings = []), (this.__originalMappings = []));
          for (var A = 0; A < this._sections.length; A++)
            for (
              var E = this._sections[A],
                D = E.consumer._generatedMappings,
                C = 0;
              C < D.length;
              C++
            ) {
              ...
              var x = null;
              T.name &&
                ((x = E.consumer._names.at(T.name)),
                this._names.add(x),
                (x = this._names.indexOf(x)));
              var R = {
                source: k,
                generatedLine:
                  T.generatedLine + (E.generatedOffset.generatedLine - 1),
                generatedColumn:
                  T.generatedColumn +
                  (E.generatedOffset.generatedLine === T.generatedLine
                    ? E.generatedOffset.generatedColumn - 1
                    : 0),
  ...
  Gi = he({
    '../../node_modules/escodegen/node_modules/source-map/lib/source-node.js'(
      ...
      ((u.fromStringWithSourceMap = function (l, p, d) {
        var g = new u(),
          F = l.split(n),
          A = 0,
          E = function () {
          ...
          T = null;
        return (
          p.eachMapping(function (x) {
            if (T !== null)
              if (D < x.generatedLine) (k(T, E()), D++, (C = 0));
              else {
                var R = F[A] || '',
                  S = R.substr(0, x.generatedColumn - C);
                ((F[A] = R.substr(x.generatedColumn - C)),
                  (C = x.generatedColumn),
                  k(T, S),
                  (T = x));
                return;
              }
            for (; D < x.generatedLine; ) (g.add(E()), D++);
            if (C < x.generatedColumn) {
              var R = F[A] || '';
              (g.add(R.substr(0, x.generatedColumn)),
                (F[A] = R.substr(x.generatedColumn)),
                (C = x.generatedColumn));
            }
            T = x;
          }, this),
          A < F.length && (T && k(T, E()), g.add(F.splice(A).join(''))),
          p.sources.forEach(function (x) {
            var R = p.sourceContentFor(x);
            R != null &&
              (d != null && (x = r.join(d, x)), g.setSourceContent(x, R));
          }),
          g
        );
        function k(x, R) {
          if (x === null || x.source === void 0) g.add(R);
          else {
            var S = d ? r.join(d, x.source) : x.source;
            g.add(new u(x.originalLine, x.originalColumn, S, R, x.name));
          }
        }
      }),
        (u.prototype.add = function (l) {
          ...
          else if (l[o] || typeof l == 'string') l && this.children.push(l);
          else
            throw new TypeError(
        ...
        (u.prototype.prepend = function (l) {
          if (Array.isArray(l))
            for (var p = l.length - 1; p >= 0; p--) this.prepend(l[p]);
          else if (l[o] || typeof l == 'string') this.children.unshift(l);
          else
            throw new TypeError(
              'Expected a SourceNode, string, or an array of SourceNodes and strings. Got ' +
                l
        ...
        (u.prototype.walk = function (l) {
          for (var p, d = 0, g = this.children.length; d < g; d++)
            ((p = this.children[d]),
              p[o]
                ? p.walk(l)
                : p !== '' &&
        ...
        (u.prototype.replaceRight = function (l, p) {
          var d = this.children[this.children.length - 1];
          return (
            d[o]
              ? d.replaceRight(l, p)
              : typeof d == 'string'
                ? (this.children[this.children.length - 1] = d.replace(l, p))
                : this.children.push(''.replace(l, p)),
            this
          );
        }),
        (u.prototype.setSourceContent = function (l, p) {
          this.sourceContents[r.toSetString(l)] = p;
        }),
        (u.prototype.walkSourceContents = function (l) {
          for (var p = 0, d = this.children.length; p < d; p++)
            this.children[p][o] && this.children[p].walkSourceContents(l);
          for (
            var g = Object.keys(this.sourceContents), p = 0, d = g.length;
            p < d;
            p++
          )
            l(r.fromSetString(g[p]), this.sourceContents[g[p]]);
        }),
        ...
        (u.prototype.toStringWithSourceMap = function (l) {
  ...
  Yi = he({
    '../../node_modules/escodegen/node_modules/source-map/source-map.js'(e) {
      ((e.SourceMapGenerator = Pn().SourceMapGenerator),
        (e.SourceMapConsumer = zi().SourceMapConsumer),
        (e.SourceNode = Gi().SourceNode));
    },
  }),
  Ji = he({
    ...
    '../../node_modules/escodegen/escodegen.js'(e) {
      (function () {
        var t,
          ...
          I,
          q;
        ((o = Li()), (u = Mi()), (t = o.Syntax));
        function U(i) {
          return ye.Expression.hasOwnProperty(i.type);
        }
        function z(i) {
          return ye.Statement.hasOwnProperty(i.type);
        }
        ((r = {
          Sequence: 0,
          Yield: 1,
...
`,
        ...
        function ue(i) {
          var c = i.length;
          return c && u.code.isLineTerminator(i.charCodeAt(c - 1));
        }
        function W(i, c) {
          var a;
        ...
        function Ne(i, c) {
          ...
          for (a in c)
            c.hasOwnProperty(a) &&
              ((h = c[a]),
              m(h) ? (m(i[a]) ? Ne(i[a], h) : (i[a] = Ne({}, h))) : (i[a] = h));
          return i;
        }
        function nt(i) {
          var c, a, h, m, w;
          ...
          if (i === 1 / 0) return d ? 'null' : g ? '1e400' : '1e+400';
          if (((c = '' + i), !g || c.length < 3)) return c;
          for (
            a = c.indexOf('.'),
              !d &&
                c.charCodeAt(0) === 48 &&
            ...
            --w;
          return (
            w !== 0 && ((m -= w), (h = h.slice(0, w))),
            m !== 0 && (h += 'e' + m),
            (h.length < c.length ||
              (F &&
                i > 1e12 &&
                Math.floor(i) === i &&
                (h = '0x' + i.toString(16)).length < c.length)) &&
              +h === i &&
              (c = h),
            c
          );
        ...
        function li(i) {
          ...
          if (((a = i.toString()), i.source)) {
            ...
            for (
              h = c[1], a = '', O = !1, V = !1, m = 0, w = i.source.length;
              m < w;
              ++m
            )
              ((P = i.source.charCodeAt(m)),
                V
                  ? ((a += mt(P, V)), (V = !1))
                  : (O
                      ? P === 93 && (O = !1)
        ...
        function pi(i) {
          var c, a, h, m;
          for (m = A === 'double' ? '"' : "'", c = 0, a = i.length; c < a; ++c)
            if (((h = i.charCodeAt(c)), h === 39)) {
              m = '"';
              break;
            } else if (h === 34) {
              m = "'";
        ...
        function fi(i) {
          ...
          for (a = 0, h = i.length; a < h; ++a) {
            if (((m = i.charCodeAt(a)), m === 39)) ++w;
            else if (m === 34) ++P;
            else if (m === 47 && d) c += '\\';
            else if (u.code.isLineTerminator(m) || m === 92) {
              c += hi(m);
              continue;
            } else if (
              !u.code.isIdentifierPartES5(m) &&
              ((d && m < 32) || (!d && !E && (m < 32 || m > 126)))
            ) {
              c += ci(m, i.charCodeAt(a + 1));
              continue;
            }
            c += String.fromCharCode(m);
          }
          if (
            ((O = !(A === 'double' || (A === 'auto' && P < w))),
            (V = O ? "'" : '"'),
            !(O ? w : P))
          )
            return V + c + V;
          for (i = c, c = V, a = 0, h = i.length; a < h; ++a)
            ((m = i.charCodeAt(a)),
              ((m === 39 && O) || (m === 34 && !O)) && (c += '\\'),
              (c += String.fromCharCode(m)));
          return c + V;
        ...
        function Nr(i) {
          ...
          for (c = 0, a = i.length; c < a; ++c)
            ((h = i[c]), (m += Array.isArray(h) ? Nr(h) : h));
          return m;
        }
        function fe(i, c) {
          if (!y) return Array.isArray(i) ? Nr(i) : i;
          if (c == null) {
            if (i instanceof s) return i;
            c = {};
          }
          return c.loc == null
            ? new s(null, null, y, i, c.name || null)
            : new s(
                c.loc.start.line,
                c.loc.start.column,
                y === !0 ? c.loc.source || null : y,
                i,
                c.name || null
              );
        }
          ...
          return (
            ...
            a.length === 0
              ...
              : ((h = fe(c).toString()),
                h.length === 0
                  ? [i]
                  : ((m = a.charCodeAt(a.length - 1)),
                    (w = h.charCodeAt(0)),
                    ((m === 43 || m === 45) && m === w) ||
                    (u.code.isIdentifierPartES5(m) &&
                      u.code.isIdentifierPartES5(w)) ||
                    (m === 47 && w === 105)
                      ? [i, _e(), c]
                      : u.code.isWhiteSpace(m) ||
                          u.code.isLineTerminator(m) ||
                          u.code.isWhiteSpace(w) ||
                          u.code.isLineTerminator(w)
                        ? [i, c]
                        : [i, C, c]))
          );
        }
        ...
        function di(i) {
          ...
          for (
            c = i.length - 1;
            c >= 0 && !u.code.isLineTerminator(i.charCodeAt(c));
            --c
          );
          return i.length - 1 - c;
        }
        function mi(i, c) {
          var a, h, m, w, P, O, V, ae;
          for (
            a = i.split(/\r\n|[\r\n]/),
              O = Number.MAX_VALUE,
              h = 1,
            ...
            for (
              w = a[h], P = 0;
              P < w.length && u.code.isWhiteSpace(w.charCodeAt(P));
            )
              ++P;
            O > P && (O = P);
          }
          for (
            ...
            ((ae = fe(xe(a[h].slice(O)))), (a[h] = y ? ae.join('') : ae));
          return (
            (l = V),
            a.join(`
`)
...
`),
        ...
        function jr(i, c) {
          var a, h, m, w, P, O, V, ae, ve, Qe, st, qr, Ur, je;
          if (i.leadingComments && i.leadingComments.length > 0) {
            if (((w = c), B)) {
              for (
                m = i.leadingComments[0],
                  c = [],
                  ae = m.extendedRange,
                  ve = m.range,
                  st = _.substring(ae[0], ve[0]),
                  je = (st.match(/\n/g) || []).length,
                  je > 0
                    ? (c.push(
                        $(
...
`,
                      ...
                      c.push(xe(We(m))))
                    : (c.push(st), c.push(We(m))),
                  Qe = ve,
                  a = 1,
                  h = i.leadingComments.length;
                a < h;
                a++
              )
                ((m = i.leadingComments[a]),
                  (ve = m.range),
                  (qr = _.substring(Qe[1], ve[0])),
                  (je = (qr.match(/\n/g) || []).length),
                  c.push(
                    $(
                      `
...
`,
              ...
              for (
                P = !ue(fe(c).toString()),
                  O = $(' ', di(fe([l, c, p]).toString())),
                  a = 0,
                  h = i.trailingComments.length;
                a < h;
                ++a
              )
                ((m = i.trailingComments[a]),
                  P
                    ? (a === 0 ? (c = [c, p]) : (c = [c, O]), c.push(We(m, O)))
                    : (c = [c, xe(We(m))]),
                  a !== h - 1 &&
                    !ue(fe(c).toString()) &&
                    (c = [
...
` && m++;
        ...
        function gi(i, c) {
          ...
          return (
            (a = i[S.verbatim]),
            typeof a == 'string'
              ? (h = Fe(Mr(a), r.Sequence, c))
              : ((h = Mr(a.content)),
                (m = a.precedence != null ? a.precedence : r.Sequence),
                (h = Fe(h, m, c))),
            fe(h, i)
          );
        }
        function ye() {}
        ((ye.prototype.maybeBlock = function (i, c) {
          var a,
            h,
            m = this;
          return (
            (h = !S.comment || !i.leadingComments),
            i.type === t.BlockStatement && h
              ? [C, this.generateStatement(i, c)]
              : i.type === t.EmptyStatement && h
                ? ';'
                : (Ce(function () {
                    a = [D, xe(m.generateStatement(i, c))];
                  }),
                  a)
          );
        }),
          (ye.prototype.maybeBlockSuffix = function (i, c) {
            var a = ue(fe(c).toString());
            return i.type === t.BlockStatement &&
              (!S.comment || !i.leadingComments) &&
              !a
              ? [c, C]
              : a
                ? [c, l]
        ...
        function gt(i, c) {
          return i.async ? 'async' + (c ? _e() : C) : '';
        }
        function Tt(i) {
          var c = i.generator && !S.moz.starlessGenerator;
          return c ? '*' + C : '';
        }
        function Vr(i) {
          var c = i.value,
            a = '';
          return (
            c.async && (a += gt(c, !i.computed)),
            c.generator && (a += Tt(c) ? '*' : ''),
            a
          );
        }
        ((ye.prototype.generatePattern = function (i, c, a) {
          return i.type === t.Identifier
            ? ke(i)
            : this.generateExpression(i, c, a);
        }),
          (ye.prototype.generateFunctionParams = function (i) {
            var c, a, h, m;
            if (
              ((m = !1),
              ...
              h = [gt(i, !0), ke(i.params[0])];
            else {
              for (
                h = i.type === t.ArrowFunctionExpression ? [gt(i, !1)] : [],
                  h.push('('),
                  i.defaults && (m = !0),
                  c = 0,
                  a = i.params.length;
                ...
                (m && i.defaults[c]
                  ...
                  : h.push(this.generatePattern(i.params[c], r.Assignment, b)),
                  c + 1 < a && h.push(',' + C));
              (i.rest &&
                (i.params.length && h.push(',' + C),
                h.push('...'),
                h.push(ke(i.rest))),
                h.push(')'));
            }
          ...
          (ye.prototype.generateFunctionBody = function (i) {
            var c, a;
            return (
              (c = this.generateFunctionParams(i)),
              i.type === t.ArrowFunctionExpression && (c.push(C), c.push('=>')),
              i.expression
                ? (c.push(C),
                  (a = this.generateExpression(i.body, r.Assignment, b)),
                  a.toString().charAt(0) === '{' && (a = ['(', a, ')']),
                  c.push(a))
                : c.push(this.maybeBlock(i.body, se)),
              c
            );
          }),
          (ye.prototype.generateIterationForStatement = function (i, c, a) {
            var h = ['for' + (c.await ? _e() + 'await' : '') + C + '('],
              m = this;
            return (
              Ce(function () {
                (c.left.type === t.VariableDeclaration
                  ? Ce(function () {
                      (h.push(c.left.kind + _e()),
                        h.push(m.generateStatement(c.left.declarations[0], K)));
                    })
                  : h.push(m.generateExpression(c.left, r.Call, b)),
                  (h = J(h, i)),
                  (h = [
                    J(h, m.generateExpression(c.right, r.Assignment, b)),
                    ')',
                  ]));
              }),
          ...
          (ye.prototype.generatePropertyKey = function (i, c) {
            var a = [];
            return (
              c && a.push('['),
              a.push(this.generateExpression(i, r.Assignment, b)),
              c && a.push(']'),
              a
            );
          }),
          (ye.prototype.generateAssignment = function (i, c, a, h, m) {
            return (
              r.Assignment < h && (m |= G),
              Fe(
                [
                  this.generateExpression(i, r.Call, m),
                  C + a + C,
                  this.generateExpression(c, r.Assignment, m),
                ],
                r.Assignment,
                h
              )
          ...
          (ye.prototype.semicolon = function (i) {
            return !k && i & te ? '' : ';';
          }),
          (ye.Statement = {
            BlockStatement: function (i, c) {
              var a,
                h,
                m = ['{', D],
                w = this;
...
` && (m = ['{']),
                  ...
                  var P, O, V, ae;
                  for (
                    ae = M, c & pe && (ae |= me), P = 0, O = i.body.length;
                    P < O;
                    ++P
                  )
                    (B &&
                      (P === 0 &&
                        (i.body[0].leadingComments &&
                          ...
                          (h = _.substring(a[0], a[1])),
                          h[0] ===
                            `
` && (m = ['{'])),
                        i.body[0].leadingComments ||
                          it(i.range[0], i.body[0].range[0], m)),
                      P > 0 &&
                        !i.body[P - 1].trailingComments &&
                        !i.body[P].leadingComments &&
                        it(i.body[P - 1].range[1], i.body[P].range[0], m)),
                      P === O - 1 && (ae |= te),
                      i.body[P].leadingComments && B
                        ? (V = w.generateStatement(i.body[P], ae))
                        : (V = xe(w.generateStatement(i.body[P], ae))),
                      m.push(V),
                      ue(fe(V).toString()) ||
                        (B && P < O - 1 && i.body[P + 1].leadingComments) ||
                        m.push(D),
                      B &&
                        P === O - 1 &&
                        (i.body[P].trailingComments ||
                          it(i.body[P].range[1], i.range[1], m)));
                }),
                m.push(xe('}')),
                m
              );
            },
            BreakStatement: function (i, c) {
              return i.label
                ? 'break ' + i.label.name + this.semicolon(c)
                : 'break' + this.semicolon(c);
            },
            ContinueStatement: function (i, c) {
              return i.label
                ? 'continue ' + i.label.name + this.semicolon(c)
                : 'continue' + this.semicolon(c);
            },
            ClassBody: function (i, c) {
              var a = ['{', D],
                h = this;
              return (
                Ce(function (m) {
                  var w, P;
                  for (w = 0, P = i.body.length; w < P; ++w)
                    (a.push(m),
                      a.push(h.generateExpression(i.body[w], r.Sequence, b)),
                      w + 1 < P && a.push(D));
                }),
                ue(fe(a).toString()) || a.push(D),
                a.push(l),
                a.push('}'),
                a
              );
            },
            ClassDeclaration: function (i, c) {
              var a, h;
              return (
                (a = ['class']),
                i.id &&
                  (a = J(a, this.generateExpression(i.id, r.Sequence, b))),
                i.superClass &&
                  ((h = J(
                    'extends',
                    this.generateExpression(i.superClass, r.Unary, b)
                  )),
                  (a = J(a, h))),
                a.push(C),
                a.push(this.generateStatement(i.body, H)),
                a
              );
            },
            DirectiveStatement: function (i, c) {
              return S.raw && i.raw
                ? i.raw + this.semicolon(c)
                : pi(i.directive) + this.semicolon(c);
            },
            DoWhileStatement: function (i, c) {
              var a = J('do', this.maybeBlock(i.body, M));
              return (
                (a = this.maybeBlockSuffix(i.body, a)),
                J(a, [
                  'while' + C + '(',
                  this.generateExpression(i.test, r.Sequence, b),
                  ')' + this.semicolon(c),
                ])
              );
            },
            CatchClause: function (i, c) {
              var a,
                h = this;
              return (
                Ce(function () {
                  ...
                  i.param
                    ? ((a = [
                        'catch' + C + '(',
                        h.generateExpression(i.param, r.Sequence, b),
                        ')',
                      ]),
                      i.guard &&
                        ((m = h.generateExpression(i.guard, r.Sequence, b)),
                        a.splice(2, 0, ' if ', m)))
                    : (a = ['catch']);
                }),
                a.push(this.maybeBlock(i.body, M)),
                a
              );
            },
            DebuggerStatement: function (i, c) {
              return 'debugger' + this.semicolon(c);
            },
            EmptyStatement: function (i, c) {
              return ';';
            },
            ExportDefaultDeclaration: function (i, c) {
              var a = ['export'],
                h;
              return (
                (h = c & te ? H : M),
                (a = J(a, 'default')),
                z(i.declaration)
                  ? (a = J(a, this.generateStatement(i.declaration, h)))
                  : (a = J(
                      a,
                      this.generateExpression(i.declaration, r.Assignment, b) +
                        this.semicolon(c)
                    )),
                a
              );
            },
            ExportNamedDeclaration: function (i, c) {
              var a = ['export'],
                h,
                m = this;
              return (
                (h = c & te ? H : M),
                i.declaration
                  ? J(a, this.generateStatement(i.declaration, h))
                  : (i.specifiers &&
                        ...
                        : i.specifiers[0].type === t.ExportBatchSpecifier
                          ...
                          : ((a = J(a, '{')),
                            Ce(function (w) {
                              var P, O;
                              for (
                                a.push(D), P = 0, O = i.specifiers.length;
                                P < O;
                                ++P
                              )
                                (a.push(w),
                      ...
                      i.source
                        ? (a = J(a, [
                            'from' + C,
                            this.generateExpression(i.source, r.Sequence, b),
                            this.semicolon(c),
                          ]))
            ...
            ExportAllDeclaration: function (i, c) {
              return [
                'export' + C,
                '*' + C,
                'from' + C,
            ...
            ExpressionStatement: function (i, c) {
              var a, h;
              function m(O) {
                var V;
                return O.slice(0, 5) !== 'class'
                  ...
                  : ((V = O.charCodeAt(5)),
                    V === 123 ||
                      u.code.isWhiteSpace(V) ||
                      u.code.isLineTerminator(V));
              }
              function w(O) {
                var V;
              ...
              function P(O) {
                ...
                if (
                  O.slice(0, 5) !== 'async' ||
                  !u.code.isWhiteSpace(O.charCodeAt(5))
                )
                  return !1;
                for (
                  ae = 6, ve = O.length;
                  ae < ve && u.code.isWhiteSpace(O.charCodeAt(ae));
                  ++ae
                );
                return ae === ve || O.slice(ae, ae + 8) !== 'function'
                  ? !1
                  : ((V = O.charCodeAt(ae + 8)),
                    V === 40 ||
                      u.code.isWhiteSpace(V) ||
              ...
              return (
                (a = [this.generateExpression(i.expression, r.Sequence, b)]),
                (h = fe(a).toString()),
                h.charCodeAt(0) === 123 ||
                m(h) ||
                w(h) ||
            ...
            ImportDeclaration: function (i, c) {
              var a,
                h,
                m = this;
              return i.specifiers.length === 0
                ...
                : ((a = ['import']),
                  (h = 0),
                  i.specifiers[h].type === t.ImportDefaultSpecifier &&
                    ((a = J(a, [
                      this.generateExpression(i.specifiers[h], r.Sequence, b),
                    ])),
                    ++h),
                  i.specifiers[h] &&
                    (h !== 0 && a.push(','),
                    i.specifiers[h].type === t.ImportNamespaceSpecifier
                      ? (a = J(a, [
                          C,
                          this.generateExpression(
                            i.specifiers[h],
                      ...
                      : (a.push(C + '{'),
                        i.specifiers.length - h === 1
                          ...
                          : (Ce(function (w) {
                              var P, O;
                              for (
                                a.push(D), P = h, O = i.specifiers.length;
                                P < O;
                                ++P
                              )
                                (a.push(w),
            ...
            VariableDeclarator: function (i, c) {
              var a = c & G ? b : Re;
              return i.init
                ? [
            ...
            VariableDeclaration: function (i, c) {
              var a,
                h,
                m,
                w,
              ...
              function V() {
                for (
                  w = i.declarations[0],
                    S.comment && w.leadingComments
                      ? (a.push(`
`),
                        a.push(xe(O.generateStatement(w, P))))
                      : (a.push(_e()), a.push(O.generateStatement(w, P))),
                    h = 1,
                    m = i.declarations.length;
                  h < m;
                  ++h
                )
                  ((w = i.declarations[h]),
                    S.comment && w.leadingComments
                      ? (a.push(',' + D), a.push(xe(O.generateStatement(w, P))))
                      : (a.push(',' + C), a.push(O.generateStatement(w, P))));
              }
              return (
                i.declarations.length > 1 ? Ce(V) : V(),
                a.push(this.semicolon(c)),
                a
              );
            },
            ThrowStatement: function (i, c) {
              return [
                J('throw', this.generateExpression(i.argument, r.Sequence, b)),
                this.semicolon(c),
              ];
            },
            TryStatement: function (i, c) {
              var a, h, m, w;
              if (
                ((a = ['try', this.maybeBlock(i.block, M)]),
                (a = this.maybeBlockSuffix(i.block, a)),
                i.handlers)
              )
                for (h = 0, m = i.handlers.length; h < m; ++h)
                  ((a = J(a, this.generateStatement(i.handlers[h], M))),
                    (i.finalizer || h + 1 !== m) &&
                      (a = this.maybeBlockSuffix(i.handlers[h].body, a)));
              else {
                for (
                  w = i.guardedHandlers || [], h = 0, m = w.length;
                  h < m;
                  ++h
                )
                  ((a = J(a, this.generateStatement(w[h], M))),
                    (i.finalizer || h + 1 !== m) &&
                      (a = this.maybeBlockSuffix(w[h].body, a)));
                if (i.handler)
                  if (Array.isArray(i.handler))
                    for (h = 0, m = i.handler.length; h < m; ++h)
                      ((a = J(a, this.generateStatement(i.handler[h], M))),
                        (i.finalizer || h + 1 !== m) &&
                          (a = this.maybeBlockSuffix(i.handler[h].body, a)));
                  else
                    ((a = J(a, this.generateStatement(i.handler, M))),
                      i.finalizer &&
                        (a = this.maybeBlockSuffix(i.handler.body, a)));
              }
              return (
                i.finalizer &&
                  (a = J(a, ['finally', this.maybeBlock(i.finalizer, M)])),
                a
              );
            },
            SwitchStatement: function (i, c) {
              var a,
                h,
                m,
                w,
              ...
              if (
                (Ce(function () {
                  a = [
                    'switch' + C + '(',
                    O.generateExpression(i.discriminant, r.Sequence, b),
                    ')' + C + '{' + D,
                  ];
                }),
                i.cases)
              )
                for (P = M, m = 0, w = i.cases.length; m < w; ++m)
                  (m === w - 1 && (P |= te),
                    (h = xe(this.generateStatement(i.cases[m], P))),
                    a.push(h),
                    ue(fe(h).toString()) || a.push(D));
              return (a.push(xe('}')), a);
            },
            SwitchCase: function (i, c) {
              var a,
                h,
                m,
                w,
                  ...
                  for (
                    i.test
                      ? (a = [
                          J(
                            'case',
                            O.generateExpression(i.test, r.Sequence, b)
                          ),
                          ':',
                        ])
                      : (a = ['default:']),
                      m = 0,
                      w = i.consequent.length,
                      w &&
                        i.consequent[0].type === t.BlockStatement &&
                        ((h = O.maybeBlock(i.consequent[0], M)),
                        a.push(h),
                        (m = 1)),
                      m !== w && !ue(fe(a).toString()) && a.push(D),
                      P = M;
                    m < w;
                    ++m
                  )
                    (m === w - 1 && c & te && (P |= te),
                      (h = xe(O.generateStatement(i.consequent[m], P))),
                      a.push(h),
                      m + 1 !== w && !ue(fe(h).toString()) && a.push(D));
                }),
                a
              );
            },
            IfStatement: function (i, c) {
              var a,
                h,
                m,
                w = this;
              return (
                Ce(function () {
                  a = [
                    'if' + C + '(',
                    w.generateExpression(i.test, r.Sequence, b),
                    ')',
                  ];
                }),
                (m = c & te),
                ...
                m && (h |= te),
                i.alternate
                  ? (a.push(this.maybeBlock(i.consequent, M)),
                    (a = this.maybeBlockSuffix(i.consequent, a)),
                    i.alternate.type === t.IfStatement
                      ? (a = J(a, [
                          'else ',
                          this.generateStatement(i.alternate, h),
                        ]))
                      : (a = J(a, J('else', this.maybeBlock(i.alternate, h)))))
                  : a.push(this.maybeBlock(i.consequent, h)),
                a
              );
            },
            ForStatement: function (i, c) {
              var a,
                h = this;
              return (
                Ce(function () {
                  ((a = ['for' + C + '(']),
                    i.init
                      ? i.init.type === t.VariableDeclaration
                        ? a.push(h.generateStatement(i.init, K))
                        : (a.push(h.generateExpression(i.init, r.Sequence, Re)),
                          a.push(';'))
                      : a.push(';'),
                    i.test &&
                      (a.push(C),
                      a.push(h.generateExpression(i.test, r.Sequence, b))),
                    a.push(';'),
                    i.update &&
                      (a.push(C),
                      a.push(h.generateExpression(i.update, r.Sequence, b))),
                    a.push(')'));
                }),
                a.push(this.maybeBlock(i.body, c & te ? H : M)),
                a
              );
            },
            ForInStatement: function (i, c) {
            ...
            LabeledStatement: function (i, c) {
              return [
                i.label.name + ':',
                this.maybeBlock(i.body, c & te ? H : M),
              ];
            },
            Program: function (i, c) {
              var a, h, m, w, P;
              for (
                w = i.body.length,
                  a = [
...
`
                ...
                (!x && m === w - 1 && (P |= te),
                  B &&
                    (m === 0 &&
                      (i.body[0].leadingComments ||
                        it(i.range[0], i.body[m].range[0], a)),
                    m > 0 &&
                      !i.body[m - 1].trailingComments &&
                      !i.body[m].leadingComments &&
                      it(i.body[m - 1].range[1], i.body[m].range[0], a)),
                  (h = xe(this.generateStatement(i.body[m], P))),
                  a.push(h),
                  m + 1 < w &&
                    !ue(fe(h).toString()) &&
                    ((B && i.body[m + 1].leadingComments) || a.push(D)),
                  B &&
                    m === w - 1 &&
                    (i.body[m].trailingComments ||
                      it(i.body[m].range[1], i.range[1], a)));
              return a;
            },
            FunctionDeclaration: function (i, c) {
              return [
                gt(i, !0),
                'function',
                Tt(i) || _e(),
            ...
            ReturnStatement: function (i, c) {
              return i.argument
                ? [
                    J(
                      'return',
                      this.generateExpression(i.argument, r.Sequence, b)
                    ),
                    this.semicolon(c),
                  ]
                : ['return' + this.semicolon(c)];
            },
            WhileStatement: function (i, c) {
              var a,
                h = this;
              return (
                Ce(function () {
                  a = [
                    'while' + C + '(',
                    h.generateExpression(i.test, r.Sequence, b),
                    ')',
                  ];
                }),
                a.push(this.maybeBlock(i.body, c & te ? H : M)),
            ...
            WithStatement: function (i, c) {
              ...
              return (
                Ce(function () {
                  a = [
                    'with' + C + '(',
                    h.generateExpression(i.object, r.Sequence, b),
                    ')',
                  ];
                }),
                a.push(this.maybeBlock(i.body, c & te ? H : M)),
          ...
          W(ye.prototype, ye.Statement),
          (ye.Expression = {
            SequenceExpression: function (i, c, a) {
              var h, m, w;
              for (
                r.Sequence < c && (a |= G),
                  h = [],
                  m = 0,
                  w = i.expressions.length;
                m < w;
                ++m
              )
                (h.push(
                  this.generateExpression(i.expressions[m], r.Assignment, a)
                ),
                  m + 1 < w && h.push(',' + C));
              return Fe(h, r.Sequence, c);
            },
            AssignmentExpression: function (i, c, a) {
              return this.generateAssignment(i.left, i.right, i.operator, c, a);
            },
            ArrowFunctionExpression: function (i, c, a) {
              return Fe(this.generateFunctionBody(i), r.ArrowFunction, c);
            },
            ConditionalExpression: function (i, c, a) {
              return (
                r.Conditional < c && (a |= G),
                Fe(
                  [
            ...
            LogicalExpression: function (i, c, a) {
              return (
                i.operator === '??' && (a |= Ee),
                this.BinaryExpression(i, c, a)
              );
            },
            BinaryExpression: function (i, c, a) {
              var h, m, w, P, O, V;
              return (
                (P = n[i.operator]),
                (m = i.operator === '**' ? r.Postfix : P),
                (w = i.operator === '**' ? P : P + 1),
                P < c && (a |= G),
                (O = this.generateExpression(i.left, m, a)),
                (V = O.toString()),
                V.charCodeAt(V.length - 1) === 47 &&
                u.code.isIdentifierPartES5(i.operator.charCodeAt(0))
                  ? (h = [O, _e(), i.operator])
                  : (h = J(O, i.operator)),
                (O = this.generateExpression(i.right, w, a)),
                (i.operator === '/' && O.toString().charAt(0) === '/') ||
                (i.operator.slice(-1) === '<' &&
                ...
                i.operator === 'in' && !(a & G)
                  ? ['(', h, ')']
                  : (i.operator === '||' || i.operator === '&&') && a & Ee
                    ? ['(', h, ')']
                    : Fe(h, P, c)
              );
            },
            CallExpression: function (i, c, a) {
              var h, m, w;
              for (
                h = [this.generateExpression(i.callee, r.Call, Be)],
                  i.optional && h.push('?.'),
                  h.push('('),
                  m = 0,
                  w = i.arguments.length;
                m < w;
                ++m
              )
                (h.push(
                  this.generateExpression(i.arguments[m], r.Assignment, b)
                ),
                  m + 1 < w && h.push(',' + C));
              return (h.push(')'), a & ee ? Fe(h, r.Call, c) : ['(', h, ')']);
            },
            ChainExpression: function (i, c, a) {
              r.OptionalChaining < c && (a |= ee);
              var h = this.generateExpression(
                i.expression,
                r.OptionalChaining,
                a
              );
              return Fe(h, r.OptionalChaining, c);
            },
            NewExpression: function (i, c, a) {
              var h, m, w, P, O;
              if (
                ((m = i.arguments.length),
                (O = a & de && !T && m === 0 ? Q : j),
                (h = J('new', this.generateExpression(i.callee, r.New, O))),
                !(a & de) || T || m > 0)
              ) {
                for (h.push('('), w = 0, P = m; w < P; ++w)
                  (h.push(
                    this.generateExpression(i.arguments[w], r.Assignment, b)
                  ),
                    w + 1 < P && h.push(',' + C));
                h.push(')');
              }
            ...
            MemberExpression: function (i, c, a) {
              var h, m;
              return (
                (h = [
                  this.generateExpression(i.object, r.Call, a & ee ? Be : j),
                ]),
                i.computed
                  ? (i.optional && h.push('?.'),
                    h.push('['),
                  ...
                  : (!i.optional &&
                      ...
                      m.indexOf('.') < 0 &&
                        !/[eExX]/.test(m) &&
                        u.code.isDecimalDigit(m.charCodeAt(m.length - 1)) &&
                        !(m.length >= 2 && m.charCodeAt(0) === 48) &&
                        h.push(' ')),
                    h.push(i.optional ? '?.' : '.'),
                    h.push(ke(i.property))),
                Fe(h, r.Member, c)
              );
            },
            MetaProperty: function (i, c, a) {
              var h;
              return (
                (h = []),
                h.push(typeof i.meta == 'string' ? i.meta : ke(i.meta)),
                h.push('.'),
                h.push(
                  typeof i.property == 'string' ? i.property : ke(i.property)
                ),
                Fe(h, r.Member, c)
              );
            },
            UnaryExpression: function (i, c, a) {
              var h, m, w, P, O;
              return (
                (m = this.generateExpression(i.argument, r.Unary, b)),
                C === ''
                  ? (h = J(i.operator, m))
                  : ((h = [i.operator]),
                    i.operator.length > 2
                      ...
                      : ((P = fe(h).toString()),
                        ...
                        (w = m.toString().charCodeAt(0)),
                        (((O === 43 || O === 45) && O === w) ||
                          (u.code.isIdentifierPartES5(O) &&
                            u.code.isIdentifierPartES5(w))) &&
                          h.push(_e()),
                        h.push(m))),
                Fe(h, r.Unary, c)
            ...
            YieldExpression: function (i, c, a) {
              var h;
              return (
                i.delegate ? (h = 'yield*') : (h = 'yield'),
                i.argument &&
                  (h = J(h, this.generateExpression(i.argument, r.Yield, b))),
                Fe(h, r.Yield, c)
              );
            },
            AwaitExpression: function (i, c, a) {
              var h = J(
                i.all ? 'await*' : 'await',
                this.generateExpression(i.argument, r.Await, b)
              );
              return Fe(h, r.Await, c);
            },
            UpdateExpression: function (i, c, a) {
              return i.prefix
                ? Fe(
                    [
                      i.operator,
                      this.generateExpression(i.argument, r.Unary, b),
                    ],
                    r.Unary,
                    c
                  )
                : Fe(
                    [
                      this.generateExpression(i.argument, r.Postfix, b),
                      i.operator,
                    ],
                    r.Postfix,
                    c
            ...
            FunctionExpression: function (i, c, a) {
              var h = [gt(i, !0), 'function'];
              return (
                i.id
                  ? (h.push(Tt(i) || _e()), h.push(ke(i.id)))
                  : h.push(Tt(i) || C),
                h.push(this.generateFunctionBody(i)),
                h
              );
            },
            ArrayPattern: function (i, c, a) {
              return this.ArrayExpression(i, c, a, !0);
            },
            ArrayExpression: function (i, c, a, h) {
              var m,
                w,
                P = this;
              return i.elements.length
                ? ((w = h ? !1 : i.elements.length > 1),
                  (m = ['[', w ? D : '']),
                  Ce(function (O) {
                    var V, ae;
                    for (V = 0, ae = i.elements.length; V < ae; ++V)
                      (i.elements[V]
                        ? (m.push(w ? O : ''),
                          m.push(
                            P.generateExpression(i.elements[V], r.Assignment, b)
                          ))
                        : (w && m.push(O), V + 1 === ae && m.push(',')),
                        V + 1 < ae && m.push(',' + (w ? D : C)));
                  }),
                  w && !ue(fe(m).toString()) && m.push(D),
                  m.push(w ? l : ''),
                  m.push(']'),
                  m)
                : '[]';
            },
            RestElement: function (i, c, a) {
              return '...' + this.generatePattern(i.argument);
            },
            ClassExpression: function (i, c, a) {
              var h, m;
              return (
                (h = ['class']),
                i.id &&
                  (h = J(h, this.generateExpression(i.id, r.Sequence, b))),
                i.superClass &&
                  ((m = J(
                    'extends',
                    this.generateExpression(i.superClass, r.Unary, b)
                  ...
                  (h = J(h, m))),
                h.push(C),
                h.push(this.generateStatement(i.body, H)),
                h
              );
            },
            MethodDefinition: function (i, c, a) {
              var h, m;
              return (
                i.static ? (h = ['static' + C]) : (h = []),
                i.kind === 'get' || i.kind === 'set'
                  ? (m = [
                      J(i.kind, this.generatePropertyKey(i.key, i.computed)),
              ...
              return i.kind === 'get' || i.kind === 'set'
                ...
                : i.shorthand
                  ? i.value.type === 'AssignmentPattern'
                    ? this.AssignmentPattern(i.value, r.Sequence, b)
                    : this.generatePropertyKey(i.key, i.computed)
                  : i.method
                    ? [
                        Vr(i),
                    ...
                    : [
                        this.generatePropertyKey(i.key, i.computed),
                        ':' + C,
                        this.generateExpression(i.value, r.Assignment, b),
                      ];
            },
            ObjectExpression: function (i, c, a) {
              var h,
                m,
                w,
                P = this;
              return i.properties.length
                ? ((h = i.properties.length > 1),
                  Ce(function () {
                    w = P.generateExpression(i.properties[0], r.Sequence, b);
                  }),
                  !h && !N(fe(w).toString())
                    ? ['{', C, w, C, '}']
                    : (Ce(function (O) {
                        ...
                        if (((m = ['{', D, O, w]), h))
                          for (
                            m.push(',' + D), V = 1, ae = i.properties.length;
                            V < ae;
                            ++V
                          )
                            (m.push(O),
                      ...
                      ue(fe(m).toString()) || m.push(D),
                      m.push(l),
                      m.push('}'),
                      m))
                : '{}';
            },
            AssignmentPattern: function (i, c, a) {
              return this.generateAssignment(i.left, i.right, '=', c, a);
            },
            ObjectPattern: function (i, c, a) {
              var h,
                m,
                w,
                P,
              ...
              if (((P = !1), i.properties.length === 1))
                ((O = i.properties[0]),
                  O.type === t.Property &&
                    O.value.type !== t.Identifier &&
                    (P = !0));
              else
                for (m = 0, w = i.properties.length; m < w; ++m)
                  if (
                    ((O = i.properties[m]),
              ...
              return (
                ...
                Ce(function (ae) {
                  var ve, Qe;
                  for (ve = 0, Qe = i.properties.length; ve < Qe; ++ve)
                    (h.push(P ? ae : ''),
                      h.push(
                        V.generateExpression(i.properties[ve], r.Sequence, b)
                      ),
                      ve + 1 < Qe && h.push(',' + (P ? D : C)));
                }),
                P && !ue(fe(h).toString()) && h.push(D),
                h.push(P ? l : ''),
                h.push('}'),
                h
              );
            },
            ThisExpression: function (i, c, a) {
              return 'this';
            },
            Super: function (i, c, a) {
              return 'super';
            },
            Identifier: function (i, c, a) {
              return ke(i);
            },
            ImportDefaultSpecifier: function (i, c, a) {
              return ke(i.id || i.local);
            },
            ImportNamespaceSpecifier: function (i, c, a) {
              var h = ['*'],
                m = i.id || i.local;
              return (m && h.push(C + 'as' + _e() + ke(m)), h);
            },
            ImportSpecifier: function (i, c, a) {
              var h = i.imported,
                m = [h.name],
                w = i.local;
              return (
                w && w.name !== h.name && m.push(_e() + 'as' + _e() + ke(w)),
                m
              );
            },
            ExportSpecifier: function (i, c, a) {
              var h = i.local,
                m = [h.name],
                w = i.exported;
              return (
            ...
            Literal: function (i, c, a) {
              var h;
              if (i.hasOwnProperty('raw') && v && S.raw)
                try {
                  if (
                    ((h = v(i.raw).body[0].expression),
                    h.type === t.Literal && h.value === i.value)
                  )
                    return i.raw;
                } catch {}
              return i.regex
            ...
            GeneratorExpression: function (i, c, a) {
              return this.ComprehensionExpression(i, c, a);
            },
            ComprehensionExpression: function (i, c, a) {
              var h,
                m,
                w,
                P,
                O = this;
              return (
                (h = i.type === t.GeneratorExpression ? ['('] : ['[']),
                S.moz.comprehensionExpressionStartsWithAssignment &&
                  ((P = this.generateExpression(i.body, r.Assignment, b)),
                  h.push(P)),
                i.blocks &&
                  Ce(function () {
                    for (m = 0, w = i.blocks.length; m < w; ++m)
                      ((P = O.generateExpression(i.blocks[m], r.Sequence, b)),
                        m > 0 ||
                        S.moz.comprehensionExpressionStartsWithAssignment
                          ? (h = J(h, P))
                          : h.push(P));
                ...
                i.filter &&
                  ((h = J(h, 'if' + C)),
                  (P = this.generateExpression(i.filter, r.Sequence, b)),
                  (h = J(h, ['(', P, ')']))),
                S.moz.comprehensionExpressionStartsWithAssignment ||
                  ((P = this.generateExpression(i.body, r.Assignment, b)),
                  (h = J(h, P))),
                h.push(i.type === t.GeneratorExpression ? ')' : ']'),
                h
              );
            },
            ComprehensionBlock: function (i, c, a) {
              var h;
              return (
                i.left.type === t.VariableDeclaration
                  ? (h = [
                      i.left.kind,
                      _e(),
                      this.generateStatement(i.left.declarations[0], K),
                    ])
                  : (h = this.generateExpression(i.left, r.Call, b)),
                (h = J(h, i.of ? 'of' : 'in')),
                (h = J(h, this.generateExpression(i.right, r.Sequence, b))),
                ['for' + C + '(', h, ')']
              );
            },
            SpreadElement: function (i, c, a) {
              return [
                '...',
                this.generateExpression(i.argument, r.Assignment, b),
              ];
            },
            TaggedTemplateExpression: function (i, c, a) {
              var h = Be;
              a & ee || (h = j);
              var m = [
                this.generateExpression(i.tag, r.Call, h),
                this.generateExpression(i.quasi, r.Primary, X),
              ];
              return Fe(m, r.TaggedTemplate, c);
            },
            TemplateElement: function (i, c, a) {
              return i.value.raw;
            },
            TemplateLiteral: function (i, c, a) {
              var h, m, w;
              for (h = ['`'], m = 0, w = i.quasis.length; m < w; ++m)
                (h.push(this.generateExpression(i.quasis[m], r.Primary, b)),
                  m + 1 < w &&
                    (h.push('${' + C),
                    h.push(
                      this.generateExpression(i.expressions[m], r.Sequence, b)
                    ),
                    h.push(C + '}')));
              return (h.push('`'), h);
            },
            ModuleSpecifier: function (i, c, a) {
              return this.Literal(i, c, a);
            },
            ImportExpression: function (i, c, a) {
              return Fe(
                [
                  'import(',
                  this.generateExpression(i.source, r.Assignment, b),
                  ')',
                ],
                r.Call,
                c
          ...
          W(ye.prototype, ye.Expression),
          (ye.prototype.generateExpression = function (i, c, a) {
            var h, m;
            return (
              (m = i.type || t.Property),
              S.verbatim && i.hasOwnProperty(S.verbatim)
                ? gi(i, c)
                : ((h = this[m](i, c, a)),
                  S.comment && (h = jr(i, h)),
                  fe(h, i))
          ...
          (ye.prototype.generateStatement = function (i, c) {
            var a, h;
            return (
              (a = this[i.type](i, c)),
              S.comment && (a = jr(i, a)),
...
` &&
        ...
        function Di(i) {
          var c;
          if (((c = new ye()), z(i))) return c.generateStatement(i, M);
          if (U(i)) return c.generateExpression(i, r.Sequence, b);
          ...
          return (
            c != null
              ? (typeof c.indent == 'string' &&
                ...
                typeof c.base == 'number' && (a.format.indent.base = c.base),
                (c = Ne(a, c)),
                (p = c.format.indent.style),
                typeof c.base == 'string'
                  ? (l = c.base)
                  : (l = $(p, c.format.indent.base)))
              : ((c = a),
                (p = c.format.indent.style),
                (l = $(p, c.format.indent.base))),
            (d = c.format.json),
            (g = c.format.renumber),
            (F = d ? !1 : c.format.hexadecimal),
            (A = d ? 'double' : c.format.quotes),
            (E = c.format.escapeless),
            (D = c.format.newline),
            (C = c.format.space),
            c.format.compact && (D = C = p = l = ''),
            (T = c.format.parentheses),
            (k = c.format.semicolons),
            (x = c.format.safeConcatenation),
            (R = c.directive),
            (v = d ? null : c.parse),
            (y = c.sourceMap),
            (_ = c.sourceCode),
            (B = c.format.preserveBlankLines && _ !== null),
            (S = c),
            y &&
              (e.browser
                ? (s = global.sourceMap.SourceNode)
                : (s = Yi().SourceNode)),
            (h = Di(i)),
            y
              ? ((m = h.toStringWithSourceMap({
                  file: c.file,
                  sourceRoot: c.sourceMapRoot,
                })),
                c.sourceContent &&
                  m.map.setSourceContent(c.sourceMap, c.sourceContent),
                c.sourceMapWithCode ? m : m.map.toString())
              : ((m = { code: h.toString(), map: null }),
                c.sourceMapWithCode ? m : m.code)
          );
        }
        ((I = {
          indent: { style: '', base: 0 },
    ...
    : e < 91
      ...
      : e < 97
        ...
        : e < 123
          ? !0
          : e <= 65535
            ? e >= 170 && Rn.test(String.fromCharCode(e))
            : t === !1
              ? !1
              : mr(e, Tr);
}
        ...
        : e < 91
          ...
          : e < 97
            ...
            : e < 123
              ? !0
              : e <= 65535
                ? e >= 170 && Ln.test(String.fromCharCode(e))
                : t === !1
                  ? !1
                  : mr(e, Tr) || mr(e, Nn);
}
...
function oe(e, t) {
  return (t === void 0 && (t = {}), (t.keyword = e), (vt[e] = new ce(e, t)));
}
function ot(e, t) {
...
function gr(e, t) {
  for (var r = 1, n = 0; ; ) {
    ...
    else return new Ze(r, t - n);
  }
}
function Hi(e) {
  var t = {};
  for (var r in _t) t[r] = e && qt(e, r) ? e[r] : _t[r];
  if (
  ...
  return (Dr(t.onComment) && (t.onComment = Qi(t, t.onComment)), t);
}
function Qi(e, t) {
  return function (r, n, s, o, u, l) {
    var p = { type: r ? 'Block' : 'Line', value: n, start: s, end: o };
    (e.locations && (p.loc = new ct(this, u, l)),
      e.ranges && (p.range = [s, o]),
      t.push(p));
  };
}
function Jt(e, t) {
  return lt | (e ? Ar : 0) | (t ? Er : 0);
}
function Pt() {
...
function Xt(e) {
  var t = (yr[e] = {
    binary: $e(Mn[e] + ' ' + Cr),
    nonBinary: { General_Category: $e(Cr), Script: $e(Vn[e]) },
  });
...
function is(e, t, r) {
  return De.parseExpressionAt(e, t, r);
}
function ss(e, t) {
  return De.tokenizer(e, t);
}
var Ot,
  Rt,
  $r,
    ...
    '../../node_modules/acorn/dist/acorn.mjs'() {
      ((Ot = {
        ...
        (Ze.prototype.offset = function (e) {
          return new Ze(this.line, this.column + e);
        }),
        (ct = function (e, t, r) {
          ((this.start = t),
            (this.end = r),
        ...
        (De = function (e, t, r) {
          ...
          if (e.allowReserved !== !0) {
            for (var s = e.ecmaVersion; !(n = Ot[s]); s--);
            e.sourceType === 'module' && (n += ' await');
          }
          this.reservedWords = $e(n);
          var o = (n ? n + ' ' : '') + Ot.strict;
          ((this.reservedWordsStrict = $e(o)),
            (this.reservedWordsStrictBind = $e(o + ' ' + Ot.strictBind)),
            (this.input = String(t)),
            (this.containsEsc = !1),
            r
              ? ((this.pos = r),
...
`,
        ...
        (Je.allowDirectSuper.get = function () {
          return (this.currentThisScope().flags & tr) > 0;
        }),
        (Je.treatFunctionsAsVar.get = function () {
          return this.treatFunctionsAsVarInScope(this.currentScope());
        }),
        (De.prototype.inNonArrowFunction = function () {
        ...
        (Z.parseTopLevel = function (e) {
          ...
          if (this.inModule)
            for (
              var n = 0, s = Object.keys(this.undefinedExports);
              n < s.length;
              n += 1
            ) {
              var o = s[n];
        ...
        (Z.isLet = function (e) {
          ...
          if (n === 123) return !0;
          if (Ge(n, !0)) {
            for (var s = r + 1; Ke(this.input.charCodeAt(s), !0); ) ++s;
            var o = this.input.slice(r, s);
            if (!en.test(o)) return !0;
          }
          return !1;
        }),
        (Z.isAsyncFunction = function () {
          ...
          return (
            ...
            (t + 8 === this.input.length || !Ke(this.input.charAt(t + 8)))
          );
        }),
          ...
          switch ((this.isLet(e) && ((n = f._var), (o = 'let')), n)) {
            ...
            default:
              ...
              return n === f.name &&
                g.type === 'Identifier' &&
                this.eat(f.colon)
                ? this.parseLabeledStatement(s, d, g, e)
        ...
        (Z.parseFunctionStatement = function (e, t, r) {
          return (this.next(), this.parseFunction(e, at | (r ? 0 : Vt), !1, t));
        }),
          ...
          if (
            ...
            if ((this.next(), this.eat(f.parenL))) {
              ...
              (this.enterScope(r ? $t : 0),
                this.checkLVal(t.param, r ? ir : Me),
        ...
        (Z.parseFunction = function (e, t, r, n) {
          (this.initFunction(e),
            (this.options.ecmaVersion >= 9 ||
              ...
              (this.type === f.star && t & Vt && this.unexpected(),
              (e.generator = this.eat(f.star))),
            this.options.ecmaVersion >= 8 && (e.async = !!n),
            t & at &&
              ((e.id =
                t & ur && this.type !== f.name ? null : this.parseIdent()),
              e.id &&
                !(t & Vt) &&
                this.checkLVal(
                  e.id,
          ...
          return (
            ...
            this.enterScope(Jt(e.async, e.generator)),
            t & at || (e.id = this.type === f.name ? this.parseIdent() : null),
            ...
            this.finishNode(
              e,
              t & at ? 'FunctionDeclaration' : 'FunctionExpression'
            )
          );
        }),
        ...
        (Z.parseClassElement = function (e) {
          ...
          var r = this.startNode(),
            n = function (p, d) {
              ...
              return t.eatContextual(p)
                ? t.type !== f.parenL && (!d || !t.canInsertSemicolon())
                  ? !0
                  : (r.key && t.unexpected(),
                    (r.computed = !1),
          ...
          (s ||
            (this.options.ecmaVersion >= 8 && n('async', !0)
              ? ((o = !0),
                (s = this.options.ecmaVersion >= 9 && this.eat(f.star)))
              : n('get')
                ? (r.kind = 'get')
                : n('set') && (r.kind = 'set')),
          ...
          return (
            ...
            ((u.type === 'Identifier' && u.name === 'constructor') ||
              ...
              ? (r.kind !== 'method' &&
                ...
                o &&
                  this.raise(u.start, "Constructor can't be an async method"),
                (r.kind = 'constructor'),
                (l = e))
              : r.static &&
                u.type === 'Identifier' &&
        ...
        (Z.parseClassId = function (e, t) {
          this.type === f.name
            ? ((e.id = this.parseIdent()), t && this.checkLVal(e.id, Me, !1))
        ...
        (Z.parseExport = function (e, t) {
          ...
          if (this.eat(f._default)) {
            ...
            if (this.type === f._function || (r = this.isAsyncFunction())) {
              ...
              (this.next(),
                r && this.next(),
                (e.declaration = this.parseFunction(n, at | ur, !1, r)));
        ...
        (Z.parseImport = function (e) {
          return (
            this.next(),
            this.type === f.string
              ? ((e.specifiers = sn), (e.source = this.parseExprAtom()))
        ...
        (Ve.parseBindingList = function (e, t, r) {
          for (var n = [], s = !0; !this.eat(e); )
            if (
              (s ? (s = !1) : this.expect(f.comma), t && this.type === f.comma)
            )
              n.push(null);
            else {
            ...
            case 'Identifier':
              (t === Me &&
                ...
                r &&
                  ...
                  (r[e.name] = !0)),
                t !== rr && t !== sr && this.declareName(e.name, t, e.start));
              break;
            case 'ChainExpression':
              this.raiseRecoverable(
                e.start,
        ...
        (ne = De.prototype),
        (ne.checkPropClash = function (e, t, r) {
          if (
            ...
            if (u) {
              var l;
              (o === 'init'
                ? (l = (this.strict && u.init) || u.get || u.set)
                : (l = u.init || u[o]),
                l &&
        ...
        (ne.parseExpression = function (e, t) {
          var r = this.start,
            n = this.startLoc,
        ...
        (ne.parseMaybeAssign = function (e, t, r) {
          ...
          if ((r && (p = r.call(this, p, u, l)), this.type.isAssign)) {
            var d = this.startNodeAt(u, l);
            return (
              (d.operator = this.value),
              (d.left = this.type === f.eq ? this.toAssignable(p, !1, t) : p),
              n ||
        ...
        (ne.parseExprOp = function (e, t, r, n, s) {
          ...
          if (o != null && (!s || this.type !== f._in) && o > n) {
            ...
            var d = this.start,
              g = this.startLoc,
              F = this.parseExprOp(this.parseMaybeUnary(null, !1), d, g, o, s),
              A = this.buildBinary(t, r, e, F, p, u || l);
            return (
              ((u && this.type === f.coalesce) ||
                (l &&
                  (this.type === f.logicalOR || this.type === f.logicalAND))) &&
                this.raiseRecoverable(
                  this.start,
        ...
        (ne.buildBinary = function (e, t, r, n, s, o) {
        ...
        (ne.parseMaybeUnary = function (e, t) {
          var r = this.start,
            n = this.startLoc,
            s;
          if (
            ...
            if (
              ((s = this.parseExprSubscripts(e)), this.checkExpressionErrors(e))
            )
              return s;
        ...
        (ne.parseSubscripts = function (e, t, r, n) {
          for (
            var s =
                this.options.ecmaVersion >= 8 &&
                e.type === 'Identifier' &&
            ...
            if (
              ...
              if (o) {
                ...
                ((l.expression = u),
                  (u = this.finishNode(l, 'ChainExpression')));
              }
              return u;
            }
            e = u;
        ...
        (ne.parseSubscript = function (e, t, r, n, s, o) {
          var u = this.options.ecmaVersion >= 11,
            l = u && this.eat(f.questionDot);
          n &&
            l &&
            this.raise(
              this.lastTokStart,
          ...
          if (
            p ||
            (l && this.type !== f.parenL && this.type !== f.backQuote) ||
            this.eat(f.dot)
          ) {
            ...
            if (s && !l && !this.canInsertSemicolon() && this.eat(f.arrow))
              return (
            ...
            ((T.tag = e),
              ...
              (e = this.finishNode(T, 'TaggedTemplateExpression')));
          }
          return e;
        }),
          ...
          switch (this.type) {
            ...
            case f.regexp:
              ...
              return (
                ...
                (t.regex = { pattern: l.pattern, flags: l.flags }),
                t
              );
            case f.num:
            case f.string:
          ...
          if (this.options.ecmaVersion >= 6) {
            ...
            for (this.yieldPos = 0, this.awaitPos = 0; this.type !== f.parenR; )
              if (
                ...
                s && this.afterTrailingComma(f.parenR, !0))
              ) {
                d = !0;
                break;
                ...
                break;
              } else l.push(this.parseMaybeAssign(!1, g, this.parseParenItem));
            var D = this.start,
              C = this.startLoc;
            if (
              (this.expect(f.parenR),
              ...
              return (
                ...
                (this.yieldPos = F),
                (this.awaitPos = A),
                this.parseParenArrowList(t, r, l)
              );
            ((!l.length || d) && this.unexpected(this.lastTokStart),
              ...
              l.length > 1
                ? ((n = this.startNodeAt(o, u)),
                  (n.expressions = l),
                  this.finishNodeAt(n, 'SequenceExpression', D, C))
                : (n = l[0]));
        ...
        (ne.parseParenArrowList = function (e, t, r) {
...
`
        ...
        (ne.parseProperty = function (e, t) {
          ...
          return (
            ...
            this.isAsyncProp(r)
              ...
              : (s = !1),
            this.parsePropertyValue(r, e, n, s, o, u, t, l),
            this.finishNode(r, 'Property')
          );
        }),
        (ne.parsePropertyValue = function (e, t, r, n, s, o, u, l) {
          if (
            ((r || n) && this.type === f.colon && this.unexpected(),
            this.eat(f.colon))
          )
            ((e.value = t
        ...
        (ne.parseMethod = function (e, t, r) {
          ...
          return (
            ...
            (this.awaitPos = 0),
            (this.awaitIdentPos = 0),
            this.enterScope(Jt(t, n.generator) | er | (r ? tr : 0)),
            this.expect(f.parenL),
        ...
        (ne.parseArrowExpression = function (e, t, r) {
          var n = this.yieldPos,
            s = this.awaitPos,
            o = this.awaitIdentPos;
          return (
            this.enterScope(Jt(r, !1) | Zt),
            this.initFunction(e),
        ...
        (ne.parseFunctionBody = function (e, t, r) {
          ...
          if (n)
            ...
            ((this.labels = []),
              ...
              this.checkParams(
                e,
                !s && !o && !t && !r && this.isSimpleParamList(e.params)
              ),
              this.strict && e.id && this.checkLVal(e.id, sr),
        ...
        (ne.checkParams = function (e, t) {
          for (var r = {}, n = 0, s = e.params; n < s.length; n += 1) {
            var o = s[n];
            this.checkLVal(o, jt, t ? null : r);
          }
        }),
        (ne.parseExprList = function (e, t, r, n) {
        ...
        (ze.enterScope = function (e) {
          this.scopeStack.push(new an(e));
        }),
        (ze.exitScope = function () {
          this.scopeStack.pop();
        }),
        (ze.treatFunctionsAsVarInScope = function (e) {
          return e.flags & lt || (!this.inModule && e.flags & ut);
        }),
        (ze.declareName = function (e, t, r) {
          ...
          if (t === Me) {
            ...
            ((n =
              ...
              s.var.indexOf(e) > -1),
              s.lexical.push(e),
              this.inModule && s.flags & ut && delete this.undefinedExports[e]);
          } else if (t === ir) {
        ...
        (ze.currentThisScope = function () {
          for (var e = this.scopeStack.length - 1; ; e--) {
            var t = this.scopeStack[e];
            if (t.flags & Nt && !(t.flags & Zt)) return t;
          }
        }),
        (Ct = function (e, t, r) {
          ((this.type = ''),
            (this.start = t),
            (this.end = 0),
            e.options.locations && (this.loc = new ct(e, r)),
        ...
        (At.finishNode = function (e, t) {
          return Jr.call(this, e, t, this.lastTokEnd, this.lastTokEndLoc);
        }),
        (At.finishNodeAt = function (e, t, r, n) {
          return Jr.call(this, e, t, r, n);
        }),
        (Oe = function (e, t, r, n, s) {
          ((this.token = e),
            (this.isExpr = !!t),
        ...
        (Et.braceIsBlock = function (e) {
          ...
          return t === Ae.f_expr || t === Ae.f_stat
            ? !0
            : e === f.colon && (t === Ae.b_stat || t === Ae.b_expr)
              ? !t.isExpr
        ...
        (f.braceL.updateContext = function (e) {
          (this.context.push(this.braceIsBlock(e) ? Ae.b_stat : Ae.b_expr),
            (this.exprAllowed = !0));
        }),
        ...
        (f.parenL.updateContext = function (e) {
          var t =
            e === f._if || e === f._for || e === f._with || e === f._while;
          (this.context.push(t ? Ae.p_stat : Ae.p_expr),
            (this.exprAllowed = !0));
        }),
        ...
        (f.backQuote.updateContext = function () {
          (this.curContext() === Ae.q_tmpl
            ? this.context.pop()
            : this.context.push(Ae.q_tmpl),
            (this.exprAllowed = !1));
        }),
        (f.star.updateContext = function (e) {
          if (e === f._function) {
            var t = this.context.length - 1;
            this.context[t] === Ae.f_expr
              ? (this.context[t] = Ae.f_expr_gen)
              : (this.context[t] = Ae.f_gen);
          }
          this.exprAllowed = !0;
        }),
        ...
        (qe = function (e) {
          ((this.parser = e),
            ...
            (this.unicodeProperties =
              yr[e.options.ecmaVersion >= 11 ? 11 : e.options.ecmaVersion]),
            (this.source = ''),
            (this.flags = ''),
            (this.start = 0),
            (this.switchU = !1),
        ...
        (qe.prototype.reset = function (e, t, r) {
          var n = r.indexOf('u') !== -1;
          ((this.start = e | 0),
            (this.source = t + ''),
            (this.flags = r),
        ...
        (qe.prototype.at = function (e, t) {
          ...
          if (!(t || this.switchU) || s <= 55295 || s >= 57344 || e + 1 >= n)
            return s;
        ...
        (Y.regexp_eatPatternCharacters = function (e) {
          for (var t = e.pos, r = 0; (r = e.current()) !== -1 && !Xr(r); )
            e.advance();
          return e.pos !== t;
        }),
        ...
        (Y.regexp_eatRegExpIdentifierStart = function (e) {
          ...
          return (
            ...
            n === 92 &&
              ...
              (n = e.lastIntValue),
            Ki(n) ? ((e.lastIntValue = n), !0) : ((e.pos = t), !1)
          );
        }),
        (Y.regexp_eatRegExpIdentifierPart = function (e) {
          ...
          return (
            ...
            n === 92 &&
              this.regexp_eatRegExpUnicodeEscapeSequence(e, r) &&
              (n = e.lastIntValue),
            Zi(n) ? ((e.lastIntValue = n), !0) : ((e.pos = t), !1)
          );
        }),
        ...
        (Y.regexp_eatControlLetter = function (e) {
          var t = e.current();
          return In(t) ? ((e.lastIntValue = t % 32), e.advance(), !0) : !1;
        }),
        ...
        (Y.regexp_eatCharacterClassEscape = function (e) {
          var t = e.current();
          if (es(t)) return ((e.lastIntValue = -1), e.advance(), !0);
          if (
            e.switchU &&
            this.options.ecmaVersion >= 9 &&
            (t === 80 || t === 112)
        ...
        (Y.regexp_eatClassAtom = function (e) {
          ...
          if (e.eat(92)) {
            ...
            if (e.switchU) {
              var r = e.current();
              ((r === 99 || Kr(r)) && e.raise('Invalid class escape'),
                e.raise('Invalid escape'));
            }
            e.pos = t;
          }
        ...
        (Y.regexp_eatHexDigits = function (e) {
          var t = e.pos,
            r = 0;
          for (e.lastIntValue = 0; Hr((r = e.current())); )
            ((e.lastIntValue = 16 * e.lastIntValue + Qr(r)), e.advance());
          return e.pos !== t;
        }),
        ...
        (Y.regexp_eatFixedHexDigits = function (e, t) {
          ...
          for (var n = 0; n < t; ++n) {
            var s = e.current();
            if (!Hr(s)) return ((e.pos = r), !1);
            ((e.lastIntValue = 16 * e.lastIntValue + Qr(s)), e.advance());
          }
          return !0;
        }),
        (yt = function (e) {
          ((this.type = e.type),
            ...
            (this.start = e.start),
            (this.end = e.end),
            e.options.locations && (this.loc = new ct(e, e.startLoc, e.endLoc)),
        ...
        (ie.skipBlockComment = function () {
          ...
          if (
            ...
            et.lastIndex = t;
            for (var n; (n = et.exec(this.input)) && n.index < this.pos; )
        ...
        (ie.skipLineComment = function (e) {
          for (
            ...
            this.pos < this.input.length && !ot(n);
          )
          ...
          e: for (; this.pos < this.input.length; ) {
            ...
            switch (e) {
              ...
              default:
                if (
                  (e > 8 && e < 14) ||
                  (e >= 5760 && Wt.test(String.fromCharCode(e)))
                )
                  ++this.pos;
                else break e;
            }
        ...
        (ie.readToken_plus_min = function (e) {
          ...
          return t === e
            ? t === 45 &&
              ...
              (this.lastTokEnd === 0 ||
                Te.test(this.input.slice(this.lastTokEnd, this.pos)))
        ...
        (ie.readRegexp = function () {
          for (var e, t, r = this.pos; ; ) {
            ...
            if (
              (Te.test(n) && this.raise(r, 'Unterminated regular expression'),
              e)
            )
              e = !1;
            else {
          ...
          var l = this.regexpState || (this.regexpState = new qe(this));
          (l.reset(r, s, u),
        ...
        (ie.readRadixNumber = function (e) {
          ...
          return (
            ...
            this.input.charCodeAt(this.pos) === 110
              ? ((r = Zr(this.input.slice(t, this.pos))), ++this.pos)
        ...
        (ie.readNumber = function (e) {
          ...
          if (!r && !e && this.options.ecmaVersion >= 11 && n === 110) {
            var s = Zr(this.input.slice(t, this.pos));
            return (
              ++this.pos,
              Ge(this.fullCharCodeAtPos()) &&
                this.raise(this.pos, 'Identifier directly after number'),
          ...
          (r && /[89]/.test(this.input.slice(t, this.pos)) && (r = !1),
            ...
            Ge(this.fullCharCodeAtPos()) &&
              this.raise(this.pos, 'Identifier directly after number'));
          var o = rs(this.input.slice(t, this.pos), r);
          ...
          for (var t = '', r = ++this.pos; ; ) {
            ...
            n === 92
              ? ((t += this.input.slice(r, this.pos)),
                ...
                (r = this.pos))
              : (ot(n, this.options.ecmaVersion >= 10) &&
                  this.raise(this.start, 'Unterminated string constant'),
                ++this.pos);
          }
          return (
        ...
        (ie.tryReadTemplateToken = function () {
          ...
          try {
            ...
            if (e === hr) this.readInvalidTemplateToken();
            else throw e;
          }
          this.inTemplateElement = !1;
        }),
        (ie.invalidStringToken = function (e, t) {
          if (this.inTemplateElement && this.options.ecmaVersion >= 9) throw hr;
          this.raise(e, t);
        }),
...
`;
        ...
        (ie.readWord1 = function () {
          ...
          for (
            ...
            if (Ke(s, n)) this.pos += s <= 65535 ? 1 : 2;
            else if (s === 92) {
    ...
    '../../node_modules/acorn-jsx/index.js'(e, t) {
      ...
      function u(d) {
        ...
        if (!g) {
          let F = d.tokTypes,
            ...
            C = new A('</tag', !1),
            T = new A('<tag>...</tag>', !0, !0),
            k = { tc_oTag: D, tc_cTag: C, tc_expr: T },
            x = {
          ...
          ((x.jsxTagStart.updateContext = function () {
            ...
            (x.jsxTagEnd.updateContext = function (R) {
      ...
      ((t.exports = function (d) {
            ...
            return p(
              {
                ...
                allowNamespacedObjects: !!d.allowNamespacedObjects,
              },
              g
            );
          }
        ...
        Object.defineProperty(t.exports, 'tokTypes', {
          get: function () {
            return u((vr(), Wr(dr))).tokTypes;
          },
          configurable: !0,
          enumerable: !0,
        }));
      function p(d, g) {
        let F = g.acorn || (vr(), Wr(dr)),
          A = u(F),
          E = F.tokTypes,
          D = A.tokTypes,
          C = F.tokContexts,
          T = A.tokContexts.tc_oTag,
          k = A.tokContexts.tc_cTag,
          x = A.tokContexts.tc_expr,
          R = F.isNewLine,
          S = F.isIdentifierStart,
          v = F.isIdentifierChar;
        return class extends g {
          ...
          jsx_readNewLine(y) {
            ...
            return (
              ++this.pos,
              _ === 13 && this.input.charCodeAt(this.pos) === 10
                ? (++this.pos,
                  (B = y
                    ? `
`
...
`))
          ...
          jsx_readString(y) {
            ...
            for (;;) {
              ...
              if (I === y) break;
              I === 38
                ? ((_ += this.input.slice(B, this.pos)),
                  (_ += this.jsx_readEntity()),
                  (B = this.pos))
                : R(I)
                  ? ((_ += this.input.slice(B, this.pos)),
                    (_ += this.jsx_readNewLine(!1)),
                    (B = this.pos))
                  : ++this.pos;
            }
            return (
              (_ += this.input.slice(B, this.pos++)),
              this.finishToken(E.string, _)
            );
          }
          jsx_readEntity() {
            let y = '',
            ...
            let q = ++this.pos;
            for (; this.pos < this.input.length && _++ < 10; ) {
              if (((I = this.input[this.pos++]), I === ';')) {
                y[0] === '#'
                  ? y[1] === 'x'
                    ? ((y = y.substr(2)),
                      n.test(y) && (B = String.fromCharCode(parseInt(y, 16))))
                    : ((y = y.substr(1)),
                      s.test(y) && (B = String.fromCharCode(parseInt(y, 10))))
                  : (B = r[y]);
                break;
              }
              y += I;
          ...
          jsx_readWord() {
            ...
            while (v(y) || y === 45);
            return this.finishToken(D.jsxName, this.input.slice(_, this.pos));
          }
          jsx_parseIdentifier() {
          ...
          jsx_parseAttribute() {
            ...
            return this.eat(E.braceL)
              ...
              : ((y.name = this.jsx_parseNamespacedName()),
                (y.value = this.eat(E.eq)
                  ? this.jsx_parseAttributeValue()
                  : null),
                this.finishNode(y, 'JSXAttribute'));
          }
          jsx_parseOpeningElementAt(y, _) {
            let B = this.startNodeAt(y, _);
            B.attributes = [];
            let I = this.jsx_parseElementName();
            for (
              I && (B.name = I);
              this.type !== E.slash && this.type !== D.jsxTagEnd;
            )
              B.attributes.push(this.jsx_parseAttribute());
            return (
              (B.selfClosing = this.eat(E.slash)),
              this.expect(D.jsxTagEnd),
              this.finishNode(B, I ? 'JSXOpeningElement' : 'JSXOpeningFragment')
            );
          }
          jsx_parseClosingElementAt(y, _) {
            let B = this.startNodeAt(y, _),
              I = this.jsx_parseElementName();
            return (
              I && (B.name = I),
              this.expect(D.jsxTagEnd),
              this.finishNode(B, I ? 'JSXClosingElement' : 'JSXClosingFragment')
            );
          }
          jsx_parseElementAt(y, _) {
            let B = this.startNodeAt(y, _),
              I = [],
              q = this.jsx_parseOpeningElementAt(y, _),
              U = null;
            if (!q.selfClosing) {
              e: for (;;)
                switch (this.type) {
                  case D.jsxTagStart:
                    if (
                      ...
                      U = this.jsx_parseClosingElementAt(y, _);
                      break e;
                    }
                    I.push(this.jsx_parseElementAt(y, _));
                    break;
                  case D.jsxText:
          ...
          jsx_parseElement() {
            let y = this.start,
              _ = this.startLoc;
            return (this.next(), this.jsx_parseElementAt(y, _));
          }
          parseExprAtom(y) {
          ...
          readToken(y) {
            let _ = this.curContext();
            if (_ === x) return this.jsx_readToken();
            if (_ === T || _ === k) {
              if (S(y)) return this.jsx_readWord();
              if (y == 62) return (++this.pos, this.finishToken(D.jsxTagEnd));
              if ((y === 34 || y === 39) && _ == T)
                return this.jsx_readString(y);
            }
            return y === 60 &&
              this.exprAllowed &&
          ...
          updateContext(y) {
            if (this.type == E.braceL) {
              ...
              (_ == T
                ...
                (this.exprAllowed = !0));
            } else if (this.type === E.slash && y === D.jsxTagStart)
    ...
    '../../node_modules/@base2/pretty-print-object/dist/index.js'(e) {
      var t =
          ...
          function () {
            return (
              (t =
                Object.assign ||
                function (p) {
                  for (var d, g = 1, F = arguments.length; g < F; g++) {
                    d = arguments[g];
                    for (var A in d)
        ...
        r =
          (e && e.__spreadArrays) ||
          function () {
            for (var p = 0, d = 0, g = arguments.length; d < g; d++)
              p += arguments[d].length;
            for (var F = Array(p), A = 0, d = 0; d < g; d++)
              for (var E = arguments[d], D = 0, C = E.length; D < C; D++, A++)
                F[A] = E[D];
            return F;
          };
...
`,
        ...
        var D = function (k) {
          if (A.inlineCharacterLimit === void 0) return k;
          var x = k
            .replace(new RegExp(E.newLine, 'g'), '')
            .replace(new RegExp(E.newLineOrSpace, 'g'), ' ')
            .replace(new RegExp(E.pad + '|' + E.indent, 'g'), '');
          return x.length <= A.inlineCharacterLimit
            ? x
            : k
                .replace(
                  new RegExp(E.newLine + '|' + E.newLineOrSpace, 'g'),
                  `
`
                )
                .replace(new RegExp(E.pad, 'g'), g)
                .replace(new RegExp(E.indent, 'g'), g + A.indent);
        };
        ...
        if (Array.isArray(p)) {
          ...
          var C =
            ...
            p
              .map(function (k, x) {
                var R = p.length - 1 === x ? E.newLine : ',' + E.newLineOrSpace,
                  S = l(k, A, g + A.indent);
                return (
                  A.transform && (S = A.transform(p, x, S)),
                  E.indent + S + R
                );
              })
              .join('') +
        ...
        if (s(p)) {
          var T = r(Object.keys(p), u(p));
          if (
            (A.filter &&
              (T = T.filter(function (x) {
                return A.filter && A.filter(p, x);
              })),
            T.length === 0)
          )
            return '{}';
          ...
          var C =
            ...
            E.newLine +
            T.map(function (x, R) {
              var S = T.length - 1 === R ? E.newLine : ',' + E.newLineOrSpace,
                v = typeof x == 'symbol',
                y = !v && /^[a-z$_][a-z$_0-9]*$/i.test(x.toString()),
                _ = v || y ? x : l(x, A),
                B = l(p[x], A, g + A.indent);
              return (
                A.transform && (B = A.transform(p, x, B)),
                E.indent + String(_) + ': ' + B + S
              );
            }).join('') +
            E.pad +
            '}';
...
var cn = ft(Ii()),
  ...
  fs = ft(Ri());
function Pr(e) {
  return fs.default.includes(e.toLowerCase());
}
var ds = ft(Xi());
function ms(e) {
    ...
    return d
      ? l.concat(
          d.map(function (g) {
            var F, A;
            return (A =
              (F = g.match(/[\t ]/g)) === null || F === void 0
                ? void 0
                : F.length) !== null && A !== void 0
              ? A
              : 0;
          })
        )
...
var qn = { format: { indent: { style: '  ' }, semicolons: !1 } },
  gs = { ...qn, format: { newline: '' } },
  Ds = { ...qn };
function Xe(e, t = !1) {
  return (0, ds.generate)(e, t ? gs : Ds);
}
function xr(e, t = !1) {
  return t ? As(e) : Xe(e);
}
...
var Un = (e) => e.$$typeof === Symbol.for('react.memo'),
  ys = (e) => e.$$typeof === Symbol.for('react.forward_ref');
vr();
var Fs = ft(as());
  ...
  (r || (r = L),
    (function u(l, p, d) {
      var g = d || l.type,
        F = t[g],
        A = l !== o[o.length - 1];
      (A && o.push(l), r[g](l, p, u), F && F(l, p || o, o), A && o.pop());
    })(e, n, s));
}
function Ir(e, t, r) {
  r(e, t);
...
L.BreakStatement = L.ContinueStatement = rt;
...
L.SwitchStatement = function (e, t, r) {
  ...
  for (var n = 0, s = e.cases; n < s.length; n += 1) {
    ...
    for (var u = 0, l = o.consequent; u < l.length; u += 1) {
      var p = l[u];
      r(p, t, 'Statement');
    }
  }
...
L.Expression = Ir;
L.ThisExpression = L.Super = L.MetaProperty = rt;
...
L.TemplateLiteral = function (e, t, r) {
  ...
  for (var u = 0, l = e.expressions; u < l.length; u += 1) {
    var p = l[u];
    r(p, t, 'Expression');
  }
};
L.TemplateElement = rt;
...
function ws(e) {
  let t = { type: 'Element' },
    r = wt(e.openingElement.name);
  return (r != null && (t.identifier = r), { inferredType: t, ast: e });
}
function Ts(e) {
  let t = e.callee.type === 'MemberExpression' ? e.callee.property : e.callee;
  return wt(t) === 'shape' ? Gn(e.arguments[0]) : null;
}
function Gn(e) {
  return { inferredType: { type: 'Object', depth: zn(e) }, ast: e };
}
function ks(e) {
  return { inferredType: { type: 'Array', depth: zn(e) }, ast: e };
}
function Ps(e) {
  switch (e.type) {
    case 'Identifier':
...
function Is(e) {
  let t = _s.parse(`(${e})`, { ecmaVersion: 2020 }),
    r = { inferredType: { type: 'Unknown' }, ast: t };
  if (t.body[0] != null) {
    let n = t.body[0];
    switch (n.type) {
      case 'ExpressionStatement': {
        let s = Ps(n.expression);
        s != null && (r = s);
        break;
      }
    }
...
function Jn({ inferredType: e, ast: t }) {
  let { depth: r } = e;
  if (r === 1) {
    let n = xr(t, !0);
    if (!St(n)) return ge(n);
...
function Os({ inferredType: e, ast: t }) {
  let { identifier: r } = e;
  if (r != null) return ge(Xn(e), Xe(t));
  let n = Xe(t, !0);
  return St(n) ? ge(ht, Xe(t)) : ge(n);
}
function Rs(e, t) {
...
function Ns(e) {
  ...
  if (Object.prototype.toString.call(e) !== '[object Object]') {
    ...
    return n == null ||
      !(
        (r = Object.getOwnPropertyDescriptor(e, Symbol.toStringTag)) != null &&
        r.writable
      )
      ? !1
      : e.toString() === `[object ${n}]`;
  ...
  return dn(e) === !1
    ...
    : ((t = e.constructor),
      t === void 0
        ? !0
        : ((r = t.prototype),
          !(dn(r) === !1 || r.hasOwnProperty('isPrototypeOf') === !1)));
}
var Ms = ft(os()),
  Ue = ft(cs()),
  Ye = function (e, t) {
...
var Qn = function (e) {
  ...
  Ks = function (e) {
    switch (!0) {
      ...
      case typeof e.type == 'function':
        return e.type.displayName ? e.type.displayName : Kn(e.type);
  ...
  Lr = function e(t, r) {
    var n = r.displayName,
      s = n === void 0 ? Ks : n;
    if (typeof t == 'string') return Qn(t);
    if (typeof t == 'number') return Ys(t);
    ...
    var l = t.key;
    typeof l == 'string' && l.search(/^\./) && (u.key = l);
    var p = gn(t.type.defaultProps || {}, mn),
      d = Ft.Children.toArray(t.props.children)
        .filter(Zs)
        .map(function (g) {
          return e(g, r);
        });
    return Hs && t.type === tt.Fragment ? Xs(l, d) : Js(o, u, p, d);
  };
function $s() {}
var eu = function (e) {
    return e
...
`
  ...
  tu = function (e, t, r, n) {
    var s = Gs(e),
      o = (0, Ms.prettyPrint)(s, {
        transform: function (u, l, p) {
          var d = u[l];
    ...
    return t
      ? o
          ...
          .replace(/\[ /g, '[')
          .replace(/ ]/g, ']')
      : o.replace(/\t/g, Ye(1, n.tabStop)).replace(
          /\n([^$])/g,
          `
`.concat(Ye(r + 1, n.tabStop), '$1')
        );
  },
  ru = function (e) {
    return e.replace(/"/g, '&quot;');
  ...
  nu = function (e, t, r, n) {
    ...
    if (typeof e == 'string') return '"'.concat(ru(e), '"');
    if (xt(e) === 'symbol') {
      var s = e
        .valueOf()
        .toString()
  ...
  su = function (e, t) {
    ...
    return (
      ...
      (n.type === 'string' || n.type === 'number')
        ? r.push(Qn(String(n.value) + String(t.value)))
        : (n && r.push(n), r.push(t)),
      r
    );
  },
...
`
          ...
          .map(function (u, l) {
            return l === 0 ? u : ''.concat(Ye(n, o)).concat(u);
          }).join(`
`)
      : t;
  },
  ...
  $n = function (e, t, r, n, s) {
    return s ? Ye(r, n).length + t.length > s : e.length > 1;
  },
  pu = function (e, t, r, n, s, o, u) {
  ...
  ei = function (e, t, r, n) {
    ...
    var A = n.filterProps,
      E = n.maxInlineAttributesLineLength,
...
`),
  ...
  Du = function (e, t, r, n) {
    ...
    var l = n.useFragmentShortSyntax,
      p;
    return (
      l ? (gu(e) || mu(e) ? (p = An) : (p = fu)) : (p = An),
      ei(du(p, o, u), t, r, n)
    );
  },
  Au = ['<', '>', '{', '}'],
  ...
  Yt = function (e, t, r, n) {
    ...
    if (e.type === 'string')
      return e.value ? ''.concat(yu(Cu(String(e.value)))) : '';
    if (e.type === 'ReactElement') return ei(e, t, r, n);
    if (e.type === 'ReactFragment') return Du(e, t, r, n);
...
function _u(e) {
  ...
  if (Ls(t) && Pr(t)) {
    let s = En(e, { tabStop: 0 }).replace(/\r?\n|\r/g, '');
    if (!St(s)) return ge(s);
  }
  return ge(dt, n);
}
var xu = (e) => {
    if (ri(e) && e.type != null) return _u(e);
    if (Ns(e)) {
      let t = He(JSON.stringify(e));
      return Jn(t);
    }
    if (Array.isArray(e)) {
      let t = He(JSON.stringify(e));
  ...
  Su = (e, t) => {
    let r = !1,
      n;
    if (fn(e.render)) r = !0;
    else if (e.prototype != null && fn(e.prototype.render)) r = !0;
    else {
      let o;
      try {
        n = He(e.toString());
        let { hasParams: u, params: l } = n.inferredType;
        (u
          ? l.length === 1 && l[0].type === 'ObjectPattern' && (o = e({}))
          : (o = e()),
          o != null && ri(o) && (r = !0));
      } catch {}
    }
  ...
  bu = (e) => ge(e.toString()),
  ii = { string: vu, object: xu, function: Su, default: bu };
function Bu(e = {}) {
  return { ...ii, ...e };
}
function wu(e, t, r = ii) {
  try {
    switch (typeof e) {
      case 'string':
        return r.string(e, t);
...
var Iu = 150;
function be({ name: e, short: t, compact: r, full: n, inferredType: s }) {
...
function ui(e, t) {
  ...
  switch (s) {
    ...
    case 'Object': {
      let { depth: p } = r;
      ((o = Bt), (u = p === 1 ? zt(n, !0) : null), (l = zt(n)));
      break;
    }
    case 'Element': {
      let { identifier: p } = r;
      ((o = p != null && !Pr(p) ? p : dt),
        (u = Cn(e).length === 1 ? e : null),
        (l = e));
      break;
    }
    case 'Array': {
      let { depth: p } = r;
      ((o = kr), (u = p <= 2 ? yn(n, !0) : null), (l = yn(n)));
      break;
    }
    default:
      ((o = Ou(s)), (u = Cn(e).length === 1 ? e : null), (l = e));
      break;
  }
  return be({ name: t, short: o, compact: u, full: l, inferredType: s });
}
function Ru({ raw: e }) {
  return e != null
    ? ui(e, 'custom')
    : be({ name: 'custom', short: _r, compact: _r });
}
function Lu(e) {
  let { jsDocTags: t } = e;
  return t != null && (t.params != null || t.returns != null)
    ? be({
        name: 'func',
        short: ku(t.params, t.returns),
        compact: null,
        full: Tu(t.params, t.returns),
      })
    : be({ name: 'func', short: ht, compact: ht });
}
function Nu(e, t) {
  let r = Object.keys(e.value)
      .map((u) => `${u}: ${pt(e.value[u], t).full}`)
      .join(', '),
    { inferredType: n, ast: s } = He(`{ ${r} }`),
    { depth: o } = n;
  return be({
    name: 'shape',
    short: Bt,
    compact: o === 1 && s ? zt(s, !0) : null,
    full: s ? zt(s) : null,
  });
}
function pr(e) {
...
function ju(e, t) {
  let { short: r, compact: n, full: s } = pt(e.value, t);
  return be({
    name: 'objectOf',
    short: pr(r),
    compact: n != null ? pr(n) : null,
    full: s && pr(s),
  });
}
function Mu(e, t) {
  if (Array.isArray(e.value)) {
    let r = e.value.reduce(
      (n, s) => {
        let { short: o, compact: u, full: l } = pt(s, t);
        return (n.short.push(o), n.compact.push(u), n.full.push(l), n);
      },
      { short: [], compact: [], full: [] }
    );
    return be({
  ...
  return be({ name: 'union', short: e.value, compact: null });
}
function Vu({ value: e, computed: t }) {
  return t
    ? ui(e, 'enumvalue')
    : be({ name: 'enumvalue', short: e, compact: e });
}
function qu(e) {
  if (Array.isArray(e.value)) {
    let t = e.value.reduce(
      (r, n) => {
        let { short: s, compact: o, full: u } = Vu(n);
  ...
  return be({ name: 'enum', short: e.value, compact: e.value });
}
function Br(e) {
  return `${e}[]`;
}
...
function Uu(e, t) {
  ...
  if (r === 'custom') {
    if (u === 'Object') return vn(n, s, o);
  } else if (r === 'shape') return vn(n, s, o);
  return be({ name: 'arrayOf', short: Br(n), compact: Br(n) });
}
function pt(e, t) {
  try {
    switch (e.name) {
      ...
      case 'shape':
        return Nu(e, t);
      case 'instanceOf':
        return be({ name: 'instanceOf', short: e.value, compact: e.value });
      case 'objectOf':
        return ju(e, t);
      case 'union':
        return Mu(e, t);
      ...
      case 'arrayOf':
        return Uu(e, t);
      default:
        return be({ name: e.name, short: e.name, compact: e.name });
    }
  } catch (r) {
    console.error(r);
  }
  return be({ name: 'unknown', short: 'unknown', compact: 'unknown' });
}
function Wu(e) {
  ...
  try {
    switch (t.name) {
      ...
      case 'enum':
      case 'arrayOf': {
        let { short: r, compact: n, full: s } = pt(t, e);
        return n != null && !xi(n) ? ge(n) : s ? ge(r, s) : ge(r);
      }
      case 'func': {
        let { short: r, full: n } = pt(t, e),
          s = r,
          o;
        return (n && n.length < Iu ? (s = n) : n && (o = Pu(n)), ge(s, o));
      }
      default:
        return null;
    }
...
var zu = (e, { name: t, type: r }) => {
    ...
    if (s != null) {
      if (n) return ge(Gt(s));
      let { hasParams: o } = He(e.toString()).inferredType;
      return ge(Rr(s, o));
    }
    return ge(n ? dt : ht);
  },
...
function Xu(e, t) {
  let r = t.defaultProps != null ? t.defaultProps : {},
    n = e.map((s) => Ju(s, r[s.propDef.name]));
  return Yu(n, t);
}
function Hu(e, t) {
  let { propDef: r } = e,
...
var _n = new Map();
Object.keys(cn.default).forEach((e) => {
  let t = cn.default[e];
  (_n.set(t, e), _n.set(t.isRequired, e));
});
function Ku(e, t) {
  let r = e;
  !vi(e) && !e.propTypes && Un(e) && (r = e.type);
  let n = _i(r, t);
...
var ra = (e, t) => {
      ...
      : (s = {
          displayName: (u) => {
            ...
            return u.type.displayName
              ? u.type.displayName
              : Yr(u.type, 'displayName')
                ? Yr(u.type, 'displayName')
                : (l = u.type.render) != null && l.displayName
    ...
    let o = { ...s, filterProps: (u, l) => u !== void 0, ...t };
    return Ft.Children.map(e, (u) => {
      let l = typeof u == 'number' ? u.toString() : u,
        p = (typeof fr == 'function' ? fr : fr.default)(wr(l), o);
      if (p.indexOf('&quot;') > -1) {
        let d = p.match(/\S+=\\"([^"]*)\\"/g);
        d &&
          d.forEach((g) => {
...
`
  ...
  na = { skip: 0, showFunctions: !1, enableBeautify: !0, showDefaultProps: !1 },
  ia = (e) => {
    var n;
    let t =
        (n = e == null ? void 0 : e.parameters.docs) == null
          ? void 0
          : n.source,
      r = e == null ? void 0 : e.parameters.__isArgsStory;
    return (t == null ? void 0 : t.type) === zr.DYNAMIC
      ? !1
      : !r ||
          (t == null ? void 0 : t.code) ||
          (t == null ? void 0 : t.type) === zr.CODE;
  },
  sa = (e) => {
    var t, r;
    return (
  ...
  ai = (e) => {
    ...
    let { mdxType: t, originalType: r, children: n, ...s } = e.props,
      o = [];
    return (
      n && (o = (Array.isArray(n) ? n : [n]).map(ai)),
      tt.createElement(r, s, ...o)
    );
  },
  oi = (e, t) => {
    var g, F;
    ...
    Bi(() => {
      if (!n) {
        let { id: A, unmappedArgs: E } = t;
        r.emit(Fi, { id: A, source: s, args: E });
      }
    });
    let o = e();
    if (n) return o;
    let u = { ...na, ...((t == null ? void 0 : t.parameters.jsx) || {}) },
      l =
        (F =
          (g = t == null ? void 0 : t.parameters.docs) == null
            ? void 0
            : g.source) != null && F.excludeDecorators
  ...
  ua = (e, t) => {
    let r = t.findIndex((s) => s.originalFn === oi),
  ...
  aa = {
    docs: {
      story: { inline: !0 },
      extractArgTypes: $u,
      extractComponentDescription: yi,
    },
  },
  oa = [oi],
  la = [Ci];
export {
  ua as applyDecorators,
  la as argTypesEnhancers,
  oa as decorators,
  aa as parameters,
};
