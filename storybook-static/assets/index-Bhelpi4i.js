import { c as kn } from './_commonjsHelpers-Cpj98o6Y.js';
var Je = { exports: {} };
(function (n, a) {
  (function (o, i) {
    i(a);
    ...
    function W(e) {
      var t, r;
      return (r = (t = $.exec(e)) === null || t === void 0 ? void 0 : t[0]) !==
        null && r !== void 0
        ? r
        : null;
    }
    ...
    const oe = (e) => {
      ...
      Vt = (e) => (e.length > 0 ? null : { type: 'EOF', text: '' }),
      Ut = (e) => {
        const t = W(e);
    ...
    function se(e) {
      return e.type === 'JsdocTypeKeyValue' ? Q(e) : P(e);
    }
    function Dt(e) {
    ...
    function Gt({ allowTrailingComma: e }) {
      return J({
        ...
        parseInfix: (t, r) => {
          ...
          if (
            s.length > 0 &&
            s.slice(0, -1).some((c) => c.type === 'JsdocTypeVariadic')
          )
    ...
    const Wt = J({
      ...
      le = [ce, H, z, Mt, Ct, Yt, Gt({ allowTrailingComma: !0 }), Wt, Xt, H];
    function Z({
    ...
    function A({ allowedAdditionalTokens: e }) {
      return J({
        name: 'nameParslet',
        accept: (t) =>
          t === 'Identifier' || t === 'this' || t === 'new' || e.includes(t),
        parsePrefix: (t) => {
    ...
    function ee({ pathGrammar: e, allowedTypes: t }) {
      return J({
        ...
        parsePrefix: (r) => {
          ...
          if ((r.consume(s), !r.consume(':')))
            return { type: 'JsdocTypeName', value: s };
          let c,
            y = r.lexer.current;
          if (r.consume('StringValue'))
            ...
            let x = '';
            const k = ['Identifier', '@', '/'];
            for (; k.some((S) => r.consume(S)); )
              ((x += y.text), (y = r.lexer.current));
            c = {
              type: 'JsdocTypeSpecialNamePath',
              value: x,
              specialType: s,
    ...
    const Re = [
      ...
      U = [...Re, ee({ allowedTypes: ['event'], pathGrammar: Re })];
    function pe(e) {
      let t;
    ...
    function ue({
      ...
      return J({
        ...
        parsePrefix: (c) => {
          ...
          const x = c.parseIntermediateType(m.FUNCTION);
          if (e === void 0) g.parameters = Qt(x);
          else {
            if (y && x.type === 'JsdocTypeFunction' && x.arrow)
              return ((g = x), (g.constructor = !0), g);
            g.parameters = pe(x);
          ...
          if (!r.consume('}')) {
            ...
            for (;;) {
              ...
              if (
                ...
                let k;
                (T.type === 'JsdocTypeStringValue' && (k = T.meta.quote),
                  s.elements.push({
      ...
      return J({
        ...
        parseInfix: (c, y) => {
          ...
          (s && y.type === 'JsdocTypeNullable' && ((g = !0), (y = y.element)),
            r &&
              y.type === 'JsdocTypeReadonlyProperty' &&
              ((x = !0), (y = y.element)));
          const k = (T = c.baseParser) !== null && T !== void 0 ? T : c;
          if (
            (k.acceptLexerState(c),
            y.type === 'JsdocTypeNumber' ||
              y.type === 'JsdocTypeName' ||
              y.type === 'JsdocTypeStringValue' ||
              ie(y))
          ) {
            if (ie(y) && !e) throw new d(y);
            k.consume(':');
            let S;
            y.type === 'JsdocTypeStringValue' && (S = y.meta.quote);
            const ne = k.parseType(m.KEY_VALUE);
            return (
              c.acceptLexerState(k),
              {
                type: 'JsdocTypeObjectField',
                key: ie(y) ? y : y.value.toString(),
                right: ne,
                optional: g,
                readonly: x,
                meta: { quote: S },
            ...
            if (!t) throw new d(y);
            k.consume(':');
            const S = k.parseType(m.KEY_VALUE);
            return (
              c.acceptLexerState(k),
    ...
    const Le = [
        ...
        D,
        ee({ allowedTypes: ['module', 'external', 'event'], pathGrammar: U }),
      ...
      Zt = [
        ...le,
        de({ allowKeyTypes: !1, objectFieldGrammar: zt }),
        ...
        A({ allowedAdditionalTokens: ['keyof'] }),
        ee({ allowedTypes: ['module'], pathGrammar: U }),
        Z({
          allowSquareBracketsOnAnyType: !1,
          allowJsdocNamePaths: !0,
          pathGrammar: U,
    ...
    function tn({ allowQuestionMark: e }) {
      return J({
        name: 'tupleParslet',
        accept: (t) => t === '[',
        parsePrefix: (t) => {
    ...
    const nn = J({
      ...
      an = J({
        ...
        parsePrefix: (e) => (
          e.consume('readonly'),
          {
            ...
            element: e.parseIntermediateType(m.KEY_VALUE),
          }
        ),
      }),
      on = J({
      ...
      un = J({
        ...
        parsePrefix: (e) => (
          e.consume('readonly'),
          {
            ...
            element: Bt(e.parseIntermediateType(m.ALL)),
          }
        ),
      }),
      yn = J({
      ...
      mn = [
        ...le,
        de({ allowKeyTypes: !1, objectFieldGrammar: dn }),
        un,
        je,
        nn,
        rn,
    ...
    function Ve(e, t) {
      switch (t) {
        ...
        case 'jsdoc':
          return new V(Ht, e).parse();
        case 'typescript':
          return new V(mn, e).parse();
      }
    }
    function fn(e, t = ['typescript', 'closure', 'jsdoc']) {
      let r;
      for (const s of t)
        try {
          return Ve(e, s);
      ...
      return {
        ...
        JsdocTypeVariadic: (e, t) =>
          e.meta.position === void 0
            ? '...'
            : te(e.meta.position, t(e.element), '...'),
        ...
        JsdocTypeGeneric: (e, t) => {
          if (e.meta.brackets === 'square') {
            const r = e.elements[0],
              s = t(r);
            return r.type === 'JsdocTypeUnion' ||
              r.type === 'JsdocTypeIntersection'
              ? `(${s})[]`
              : `${s}[]`;
          } else
        ...
        JsdocTypeSpecialNamePath: (e) =>
          `${e.specialType}:${I(e.value, e.meta.quote)}`,
...
`
    ...
    function R(e) {
      ...
      return (Jn.includes(e) && (t.reservedWord = !0), t);
    }
    const gn = {
      ...
      JsdocTypeSpecialNamePath: (e) =>
        R(e.specialType + ':' + I(e.value, e.meta.quote)),
      JsdocTypeName: (e) =>
        e.value !== 'function'
          ? R(e.value)
      ...
      JsdocTypeNamePath: (e, t) => {
        ...
        const c =
          e.pathType === 'inner' ? '~' : e.pathType === 'instance' ? '#' : '.';
        return R(`${r.name}${c}${s}`);
      },
      JsdocTypeSymbol: (e) => {
        let t = '',
    ...
    function Te(e, t) {
      return t.length === 2
        ...
        : { type: e, left: t[0], right: Te(e, t.slice(1)) };
    }
    const Nn = {
      JsdocTypeOptional: (e, t) => ({
        type: 'OPTIONAL',
    ...
    function En() {
      return {
        ...
        JsdocTypeFunction: (e, t) => {
          ...
          return (
            e.returnType !== void 0 && (r.returnType = t(e.returnType)),
            r
          );
        },
        JsdocTypeKeyof: (e, t) => ({
    ...
    function he(e, t, r, s, c) {
      ...
      for (const T of y) {
        const g = e[T];
        if (g !== void 0)
          if (Array.isArray(g)) for (const x of g) he(x, e, T, s, c);
          else he(g, e, T, s, c);
      }
      c == null || c(e, t, r);
    }
    ...
    ((o.catharsisTransform = wn),
      (o.identityTransformRules = En),
      (o.jtpTransform = bn),
      (o.parse = Ve),
      (o.stringify = hn),
      (o.stringifyRules = $e),
...
var ge = Je.exports,
  ...
  l = (n, a) => xn(n, 'name', { value: a, configurable: !0 });
const { UnknownArgTypesError: Sn } =
  __STORYBOOK_MODULE_CORE_EVENTS_PREVIEW_ERRORS__;
var On = l((n) => n.name === 'literal', 'isLiteral'),
  An = l((n) => n.value.replace(/['|"]/g, ''), 'toEnumOption'),
  In = l((n) => {
    switch (n.type) {
      case 'function':
      ...
      default:
        throw new Sn({ type: n, language: 'Flow' });
    }
  }, 'convertSig'),
  C = l((n) => {
    var p, u, d, f;
    ...
    switch ((typeof o < 'u' && (i.raw = o), n.name)) {
      ...
      case 'signature':
        return { ...i, ...In(n) };
      case 'union':
        return (p = n.elements) != null && p.every(On)
          ? {
              ...i,
              name: 'enum',
              value: (u = n.elements) == null ? void 0 : u.map(An),
            }
          : {
              ...i,
              name: a,
              value: (d = n.elements) == null ? void 0 : d.map(C),
            };
      case 'intersection':
        return {
          ...i,
          name: a,
          value: (f = n.elements) == null ? void 0 : f.map(C),
        };
      default:
...
l(Be, 'mapValues');
var Me = /^['"]|['"]$/g,
  Rn = l((n) => n.replace(Me, ''), 'trimQuotes'),
  _n = l((n) => Me.test(n), 'includesQuotes'),
  Ce = l((n) => {
    let a = Rn(n);
    return _n(n) || Number.isNaN(Number(a)) ? a : Number(a);
  }, 'parseLiteral'),
  Fn = /^\(.*\) => /,
  M = l((n) => {
    ...
    switch ((typeof o < 'u' && (u.raw = o), a)) {
      ...
      case 'union':
        return { ...u, name: 'union', value: p.map((f) => M(f)) };
      case 'instanceOf':
      case 'element':
      case 'elementType':
      default: {
        ...
        let f = p ? `${a}(${p})` : a,
          h = Fn.test(a) ? 'function' : 'other';
        return { ...u, name: h, value: f };
      }
    }
  }, 'convert');
const { UnknownArgTypesError: Ln } =
  __STORYBOOK_MODULE_CORE_EVENTS_PREVIEW_ERRORS__;
var jn = l((n) => {
    switch (n.type) {
      case 'function':
      ...
      default:
        throw new Ln({ type: n, language: 'Typescript' });
    }
  }, 'convertSig'),
  Y = l((n) => {
    var p, u, d, f;
        ...
        return (
          (p = n.elements) != null && p.every((v) => v.name === 'literal')
            ? (h = {
                ...
                name: 'enum',
                value:
                  (u = n.elements) == null ? void 0 : u.map((v) => Ce(v.value)),
              })
            : (h = {
                ...i,
                name: a,
                value: (d = n.elements) == null ? void 0 : d.map(Y),
              }),
          h
        );
      case 'intersection':
        return {
          ...i,
          name: a,
          value: (f = n.elements) == null ? void 0 : f.map(Y),
        };
      default:
        return { ...i, name: 'other', value: a };
    }
...
function We(n) {
  return Pe(n) ? $n(n.__docgenInfo.description) : '';
}
...
function Qe(n) {
  ...
  return a == null
    ? ['', n]
    : [n.slice(-a[0].length), n.slice(0, -a[0].length)];
}
l(Qe, 'splitCR');
function j(n) {
  let a = n.match(/^\s+/);
...
function et({ fence: n = '```' } = {}) {
  ...
  return l(function (i) {
    let p = [[]],
      u = !1;
    for (let d of i)
      (Kn.test(d.tokens.description) && !u
        ? p.push([d])
        : p[p.length - 1].push(d),
  ...
  return l(function (p) {
    ...
    if (
      (d.delimiter === '' &&
        ...
        !u.startsWith(a.end) &&
        ((d.delimiter = a.delim),
        (u = u.slice(a.delim.length)),
        ([d.postDelimiter, u] = j(u))),
      f)
    ) {
      let h = u.trimRight();
      ((d.end = u.slice(h.length - a.end.length)),
        (u = h.slice(0, -a.end.length)));
    }
    if (
      ((d.description = u), o.push({ number: i, source: p, tokens: d }), i++, f)
    ) {
      let h = o.slice();
      return ((o = null), h);
    }
...
function rt({ tokenizers: n }) {
  return l(function (a) {
    ...
    for (let p of n)
      if (
        ((i = p(i)),
        !((o = i.problems[i.problems.length - 1]) === null || o === void 0) &&
          o.critical)
      )
        break;
    return i;
...
l(st, 'getJoiner');
var qn = l((n) => n && n.startsWith('"') && n.endsWith('"'), 'isQuoted');
function it() {
  ...
  return (a) => {
    ...
    if (d[0] === '[' && d[d.length - 1] === ']') {
      ...
      if (
        ((d = N[0].trim()),
        N[1] !== void 0 && (h = N.slice(1).join('=').trim()),
        d === '')
      )
        return (
          a.problems.push({
...
l(it, 'nameTokenizer');
function ct(n = 'compact', a = _) {
  let o = Ne(n);
  return (i) => ((i.description = o(i.source, a)), i);
}
l(ct, 'descriptionTokenizer');
function Ne(n) {
  return n === 'compact' ? lt : n === 'preserve' ? pt : n;
}
l(Ne, 'getJoiner');
function lt(n, a = _) {
  return n
...
l(lt, 'compactJoiner');
var Bn = l((n, { tokens: a }, o) => (a.type === '' ? n : o), 'lineNo'),
  Mn = l(
    ({ tokens: n }) =>
      (n.delimiter === '' ? n.start : n.postDelimiter.slice(1)) + n.description,
    'getDescription'
  );
function pt(n, a = _) {
  if (n.length === 0) return '';
  n[0].tokens.description === '' &&
    n[0].tokens.delimiter === a.start &&
    (n = n.slice(1));
  let o = n[n.length - 1];
  return (
    o !== void 0 &&
  ...
  return function (v) {
    ...
    for (let ae of He(v)) {
      ...
      N.push({
        ...
        tags: X,
        source: $,
        problems: X.reduce((b, oe) => b.concat(oe.problems), []),
      });
    }
    return N;
  };
      ...
      if (i.tag === 'ignore') {
        ...
        switch (i.tag) {
          ...
          case 'argument': {
            let p = Jt(i);
            p != null &&
              (o.params == null && (o.params = []), o.params.push(p));
            break;
          }
          case 'deprecated': {
            let p = gt(i);
...
function Jt(n) {
  ...
  return {
    ...
    getTypeName: l(() => (a ? ke(a) : null), 'getTypeName'),
  };
}
l(Jt, 'extractParam');
function gt(n) {
...
function wt(n) {
  ...
  return a
    ? {
        ...
        getTypeName: l(() => ke(a), 'getTypeName'),
      }
    : null;
}
l(wt, 'extractReturns');
var F = ge.stringifyRules(),
  Wn = F.JsdocTypeObject;
F.JsdocTypeAny = () => 'any';
F.JsdocTypeObject = (n, a) => `(${Wn(n, a)})`;
...
l(ke, 'extractTypeName');
function xe(n) {
  return n.length > 90;
}
l(xe, 'isTooLongForTypeSummary');
function Pt(n) {
  return n.length > 50;
}
l(Pt, 'isTooLongForDefaultValueSummary');
function E(n, a) {
...
function Nt(n, a) {
  if (n != null) {
    let { value: o } = n;
    if (!re(o)) return Pt(o) ? E(a == null ? void 0 : a.name, o) : E(o);
  }
  return null;
}
l(Nt, 'createDefaultValue');
function Se({ name: n, value: a, elements: o, raw: i }) {
  return a ?? (o != null ? o.map(Se).join(' | ') : (i ?? n));
}
l(Se, 'generateUnionElement');
function bt({ name: n, raw: a, elements: o }) {
  return o != null
    ? E(o.map(Se).join(' | '))
    : a != null
      ? E(a.replace(/^\|\s*/, ''))
...
l(bt, 'generateUnion');
function Et({ type: n, raw: a }) {
  return a != null ? E(a) : E(n);
}
l(Et, 'generateFuncSignature');
function vt({ type: n, raw: a }) {
  return a != null ? (xe(a) ? E(n, a) : E(a)) : E(n);
}
l(vt, 'generateObjectSignature');
function kt(n) {
  let { type: a } = n;
  return a === 'object' ? vt(n) : Et(n);
}
l(kt, 'generateSignature');
function xt({ name: n, raw: a }) {
  return a != null ? (xe(a) ? E(n, a) : E(a)) : E(n);
}
l(xt, 'generateDefault');
function St(n) {
...
function At({ tsType: n, required: a }) {
  if (n == null) return null;
  let o = n.name;
  return (
    ...
    ? n.name === 'string'
      ...
      : n.name === 'enum'
        ? Array.isArray(n.value) &&
          n.value.every(
            ({ value: a }) =>
              typeof a == 'string' && a[0] === '"' && a[a.length - 1] === '"'
          )
        : !1
    : !1;
}
...
function Ft(n, a) {
  if (n != null) {
    let { value: o } = n;
    if (!re(o)) return Rt(n) && _t(a) ? E(JSON.stringify(o)) : E(o);
  }
  return null;
}
...
var Hn = l((n, a, o) => {
  ...
  cr = l((n, a) => {
    let o = Ge(n, a);
    return Ye(o) ? (Array.isArray(o) ? tr(o) : nr(o)) : [];
  }, 'extractComponentProps');
function Ae(n, a, o, i) {
  let p = Gn(a.description);
...
l(rr, 'extractComponentDescription');
const { combineParameters: ar } = __STORYBOOK_MODULE_PREVIEW_API__;
var lr = l((n) => {
    let {
        component: a,
        argTypes: o,
