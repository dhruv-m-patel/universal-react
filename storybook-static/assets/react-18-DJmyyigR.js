import { r as s } from './index-CfFaKb_3.js';
import { c as m } from './client-WsNsPytr.js';
...
var f = async (e, r, t) => {
    ...
    let { promise: i, resolve: u } = Promise.withResolvers();
  ...
  c = async (e, r) => {
    let t = n.get(e);
    return (t || ((t = m(e, r)), n.set(e, t)), t);
  };
export { f as renderElement, w as unmountElement };
